      ...
      <!--hero section-->
        <div id="ei-slider" class="ei-slider">
            <ul class="ei-slider-large">
              <?php 
                $sql = "SELECT * FROM innerpage_slider WHERE page_id='4' ORDER BY id DESC";
            ...
            <div class="row">
               <div class="col-md-12">
                  <ul class="breadcrumb op-nav ">
                     ...
                     <li><a href="#section1">Search Engine Optimization</a></li>
                     <li><a href="#section2">Social Media optimization </a></li>
                     <li><a href="#section3">Pay per Click </a></li>
                  </ul>
               </div>
            </div>
         </div>
               ...
               <div class="row">
                  <div class=" inline-block">
                     ...
                     <div class="heading-title-alt border-short-bottom text-center">
                        <h3 class="text-uppercase color-title carsue">Search Engine Optimization</h3>
                     </div>
                     <!--title-->
                    <div class="col-md-12">
                           
                               <div class="product_img">
                                 <img src="assets/img/dwarkesh/seo/1.jpg" class="product_img_res" alt="">  
            ...
            <div class="container">
               ...
               <div class="row">
                  <div class=" inline-block">
                     <!--title-->
                     <div class="heading-title-alt border-short-bottom text-center">
                        <h3 class="text-uppercase color-title carsue">Social Media optimization</h3>
                     </div>
                     <div class="col-md-12">
                           
                               <div class="product_img">
                                 <img src="assets/img/dwarkesh/seo/2.jpg" class="product_img_res" alt="">  
            ...
            <div class="container">
               ...
               <div class="row">
                  <div class=" inline-block">
                     <!--title-->
                     <div class="heading-title-alt border-short-bottom text-center">
                        <h3 class="text-uppercase color-title carsue">Pay per Click </h3>
                     </div>   
                        <div class="col-md-12">
                           
                               <div class="product_img">
                                 <img src="assets/img/dwarkesh/seo/3.jpg" class="product_img_res" alt="">  
