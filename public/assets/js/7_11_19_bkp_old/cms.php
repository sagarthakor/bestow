      ...
      <!--hero section-->
        ...
        <div id="ei-slider" class="ei-slider">
            <ul class="ei-slider-large">
               <?php 
                $sql = "SELECT * FROM innerpage_slider WHERE page_id='7' ORDER BY id DESC";
            ...
            <div class="row">
               <div class="col-md-12">
                  <ul class="breadcrumb op-nav ">
                     ...
                     <li><a href="#section2">Laravel </a></li>
                     <li><a href="#section3">Wordpress</a></li>
               ...
               <div class="row">
                  <div class=" inline-block">
                     ...
                     <div class="heading-title-alt border-short-bottom text-center">
                        <h3 class="text-uppercase color-title carsue">PHP</h3>
                     </div>
                     <!--title-->
                     <div class="row">
                        <div class="col-md-12">
            ...
            <div class="container">
               ...
               <div class="row">
                  <div class=" inline-block">
                     <!--title-->
                     <div class="heading-title-alt border-short-bottom text-center">
                        <h3 class="text-uppercase color-title carsue">Laravel</h3>
                     </div>
                     <div class="col-md-12">
                        <div class="col-md-6">
                           <div class="product_img">
            ...
            <div class="container">
               ...
               <div class="row">
                  <div class=" inline-block">
                     <!--title-->
                     <div class="heading-title-alt border-short-bottom text-center">
                        <h3 class="text-uppercase color-title carsue">Wordpress</h3>
                     </div>   
                        <div class="col-md-12">
                           <div class="col-md-6">
                              <div class="product_img">
