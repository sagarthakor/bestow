    ...
    <!--hero section-->
        <div id="ei-slider" class="ei-slider">
            <ul class="ei-slider-large">
               <?php 
                $sql = "SELECT * FROM innerpage_slider WHERE page_id='3' ORDER BY id DESC";
            ...
            <div class="row">
               <div class="col-md-12">
                  <ul class="breadcrumb op-nav ">
                     ...
                     <li><a href="#section1">Logo Design & Visiting Card Design</a></li>
                     <li><a href="#section2">Brochure Design </a></li>
                     <li><a href="#section3">Flyer Design</a></li>
                     <li><a href="#section4">Product Packaging Design</a></li>
                     <li><a href="#section5">Stationary Design</a></li>
                  </ul>
               </div>
            </div>
         </div>
               ...
               <div class="row">
                  <div class=" inline-block">
                     ...
                     <div class="heading-title-alt border-short-bottom text-center">
                        <h3 class="text-uppercase color-title carsue">Logo Design & Visiting Card Design</h3>
                     </div>
                     <!--title-->
                     <div class="row">
                        <div class="col-md-12">
                               ...
                               <div class="product_img">
                                 <img src="assets/img/dwarkesh/grapic/1.jpg" class="product_img_res" alt="">  
            ...
            <div class="container">
               ...
               <div class="row">
                  <div class=" inline-block">
                     <!--title-->
                     <div class="heading-title-alt border-short-bottom text-center">
                        <h3 class="text-uppercase color-title carsue">Brochure Design</h3>
                     </div>
                   <div class="col-md-12">
                           
                               <div class="product_img">
                                 <img src="assets/img/dwarkesh/grapic/2.jpg" class="product_img_res" alt="">  
            ...
            <div class="container">
               ...
               <div class="row">
                  <div class=" inline-block">
                     <!--title-->
                     <div class="heading-title-alt border-short-bottom text-center">
                        <h3 class="text-uppercase color-title carsue">Flyer Design</h3>
                     </div>   
                        <div class="col-md-12">
                           
                               <div class="product_img">
                                 <img src="assets/img/dwarkesh/grapic/3.jpg" class="product_img_res" alt="">  
               ...
               <div class="container">
                  ...
                  <div class="row">
                     <div class=" inline-block">
                        <!--title-->
                        <div class="heading-title-alt border-short-bottom text-center">
                           <h3 class="text-uppercase color-title carsue">Product Packaging Design</h3>
                        </div>
                        
                        <div class="col-md-12">
                           
                               <div class="product_img">
                                 <img src="assets/img/dwarkesh/grapic/4.jpg" class="product_img_res" alt="">  
               ...
               <div class="container">
                  ...
                  <div class="row">
                     <div class=" inline-block">
                        <!--title-->
                        <div class="heading-title-alt border-short-bottom text-center">
                           <h3 class="text-uppercase color-title carsue">Stationary Design</h3>
                           </div>
                        
                        <div class="col-md-12">
                           
                               <div class="product_img">
                                 <img src="assets/img/dwarkesh/grapic/5.jpg" class="product_img_res" alt="">  
