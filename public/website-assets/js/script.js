...
body_event.on("click", ".color1", function () {
    $("#color").attr("href", "../website-assets/css/color1.css");
    return false;

});
body_event.on("click", ".color2", function () {
    $("#color").attr("href", "../website-assets/css/color2.css");
    return false;
});
body_event.on("click", ".color3", function () {
    $("#color").attr("href", "../website-assets/css/color3.css");
    return false;
});
body_event.on("click", ".color4", function () {
    $("#color").attr("href", "../website-assets/css/color4.css");
    return false;
});
body_event.on("click", ".color5", function () {
    $("#color").attr("href", "../website-assets/css/color5.css");
    return false;
});
body_event.on("click", ".color6", function () {
    $("#color").attr("href", "../website-assets/css/color6.css");
    return false;
});
body_event.on("click", ".color7", function () {
    $("#color").attr("href", "../website-assets/css/color7.css");
    return false;
});
body_event.on("click", ".color8", function () {
    $("#color").attr("href", "../website-assets/css/color8.css");
    return false;
});
body_event.on("click", ".color9", function () {
    $("#color").attr("href", "../website-assets/css/color9.css");
    return false;
});
body_event.on("click", ".color10", function () {
    $("#color").attr("href", "../website-assets/css/color10.css");
    return false;
});
body_event.on("click", ".color11", function () {
    $("#color").attr("href", "../website-assets/css/color11.css");
    return false;
});
body_event.on("click", ".color12", function () {
    $("#color").attr("href", "../website-assets/css/color12.css");
    return false;
});
...
//Main beautician Product Search
function productSearch() {
    $.ajax({
        url: "/search-result",
        data: {"search": $("#search-data").val()},
...
function productMobileSearch() {
    $.ajax({
        url: "/search-result",
        data: {"search": $("#search-mobile-data").val()},
        success: function (response) {
            if (response.status) {
                window.location.href = response.url;
            }
...
ANALOG.blockUI = function (show = true) {
...
ANALOG.numericInput = function (evt) {
