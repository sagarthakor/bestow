...
class CreateDeliveryChallanItemTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('delivery_challan_item', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('delivery_challan_item');
    }
}
