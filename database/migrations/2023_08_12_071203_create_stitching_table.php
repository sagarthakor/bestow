...
class CreateStitchingTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('stitching', function (Blueprint $table) {
            ...
            $table->string('stitching_status')->nullable();
            $table->string('stitching_process')->nullable();
        });
    }
