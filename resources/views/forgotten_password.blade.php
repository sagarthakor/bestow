                ...
                <div class="wrapper-page">
                    ...
                    <div class="m-t-40 account-pages">
                        ...
                        <div class="account-content">
                            ...
                            @endif
                            {{Form::open(['method'=>'post','route'=>'user.forgot_password','class'=>'form-horizontal'])}}

                            <div class="form-group ">
                                <div class="col-xs-12">
                                    <input class="form-control" type="email" required="" name="email" placeholder="Enter Email id">
                                </div>
                            </div>
