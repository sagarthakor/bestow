                              ...
                              <!--   @if ($errors->any())
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="row justify-content-md-center">
                                            ...
                                            <div class="row">
                                             ...
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::text('vendor_name',null,['class'=>'form-control'. $errors->first('vendor_name', ' error')])}}
                                                    @if ($errors->has('vendor_name'))
                                                    <p class="help-block">{{ $errors->first('vendor_name') }}</p>
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        {{Form::select('payment_terms',$payment_terms,null,['class'=>'form-control'])}}
                                                    </div>
                                                </div>

                                        <div class="col-sm-12">

                                            <h3>Vendor Contact Person Information</h3>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                {{Form::select('billing_city',$city,null,['class'=>'form-control'. $errors->first('primary_email', ' error'),'id'=>"billing_city"])}}
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                {{Form::text('billing_postalcode',null,['class'=>'form-control'. $errors->first('primary_email', ' error'),'id'=>"billing_postalcode"])}}
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Postal Code  <span style="color: red">*</span></label>
                                            {{Form::text('shipping_postalcode',null,['class'=>'form-control'. $errors->first('shipping_postalcode', ' error'),'id'=>'shipping_postalcode'])}}
