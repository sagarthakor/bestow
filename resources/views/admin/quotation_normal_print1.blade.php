	...
	<table class="maintable">
	    	<tbody>
				...
				<td colspan="<?=$totcol?>" style="text-align: right; border-left:none;vertical-align: top;">
				    <table style="border: none;">
				        <tr> <td style="border: none;width:38%;text-align: left;">  <img src="{{asset('public/company_logo/'.$company->logo)}}" height="135px"></td>
		   ...
		   <tr>
			...
			<tr>
				...
				<td style="text-align: left;vertical-align:top;width:30%"><x-product-name :row="$item" print /><br>
    ...
    echo ($Rupees ? '<span style="font-weight:800">In Words :- Rs. ' . $Rupees : '') . $paise . " Only.</span>";
			...
			<tr>
				...
				<td colspan="<?=$totdivide;?>" style='vertical-align: top;'>
                  ...
                  <tr>
                      <td colspan="<?=$totcol?>"><div class="footer">Quote Prepared By : {{$quot->first_name}} {{$quot->last_name}}</div></td>
                  </tr>
		</tbody>
	</table>
</page>
