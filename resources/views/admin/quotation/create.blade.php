    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                {{Form::open(['method'=>'post','route'=>'post.quot_normal_save'])}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {{Form::text('quot_date',date('d-m-Y'),['required','class'=>'form-control input-daterange-datepicker','id'=>"quot_date",'autocomplete'=>'off'])}}
...
{{--                                    <th style="text-align: center;">THK</th>--}}
                                ...
                                <tr class="gradeX" id="row1">
                                    ...
                                    <td style="width: 20%">
                                        ...
                                        <div class="input-group">
                                            <select onchange="get_product(this.value,1)" name="product[]" id="product1"
                                            ...
                                            <div class="input-group-btn">
                                                <a class="btn btn-default" id="product_btn1"
                                                   onclick="product_search(1)">
                                                    <img src="{{asset('public/product_icon.png')}}"
                                                         style="height:20px ">
                                                </a>
                                            </div>
                                        </div>
...
{{--                                        <input type="text" name="inner_diamitter[]" id="inner_diamitter1"--}}
{{--                                               class="form-control">--}}
{{--                                    </td>--}}
{{--                                    <td style="vertical-align: top !important;text-align: center;">--}}
{{--                                        <input type="text" name="outer_diamitter[]" id="outer_diamitter1"--}}
{{--                                               class="form-control">--}}
{{--                                    </td>--}}
{{--                                    <td style="vertical-align: top !important;text-align: center;">--}}
{{--                                        <input type="text" name="thikness[]" id="thikness1" class="form-control">--}}
{{--                                    </td>--}}
                                    <td style="vertical-align: top !important;text-align: center;">
                                        <input type="text" name="hsn[]" id="hsn1" class="form-control">
                                    </td>
                                    <td style="vertical-align: top !important;text-align: center;">
                                        <input type="text" name="qty[]" onkeyup="cal(this)" class="qty form-control"
                                               id="qty1">
                                    </td>
                                    <td style="vertical-align: top !important;text-align: center;">
                                        <input type="text" name="price[]" class="price form-control" id="price1"
                                               onkeyup="cal(this)">
                                    </td>

                                    <td style="vertical-align: top !important;text-align: center;">
                                        <input type="text" name="total_amount[]" class="total form-control"
                                               id="total_amount1">
                                    </td>

                                    <td style="vertical-align: top !important;text-align: center;">
                                        <input type="text" name="discount_per[]" class="discount_per form-control"
                                               id="discount_per1" onkeyup="cal(this)">
                                    </td>
                                    <td style="vertical-align: top !important;text-align: center;">
                                        <input type="text" name="discount_amount[]" class="discount_amount form-control"
                                               id="discount_amount1">
                                    </td>

                                    <td style="vertical-align: top !important;text-align: center;">
                                        <input type="text" name="cgst_per[]" class="cgst_per form-control" id="cgst_per1"
                                               onkeyup="cal(this)">
                                    </td>
                                    <td style="vertical-align: top !important;text-align: center;">
                                        <input type="text" name="cgst_amount[]" class="cgst_amount form-control"
                                               id="cgst_amount1">
                                    </td>
                                    <td style="vertical-align: top !important;text-align: center;">
                                        <input type="text" name="sgst_per[]" class="sgst_per form-control" id="sgst_per1"
                                               onkeyup="cal(this)">
                                    </td>
                                    <td style="vertical-align: top !important;text-align: center;">
                                        <input type="text" name="sgst_amount[]" class="sgst_amount form-control"
                                               id="sgst_amount1">
                                    </td>
                                    <td style="vertical-align: top !important;text-align: center;">
                                        <input type="text" name="gst_per[]" class="gst_per form-control" id="gst_per1"
                                               onkeyup="cal(this)">
                                    </td>
                                    <td style="vertical-align: top !important;text-align: center;">
                                        <input type="text" name="gst_amount[]" class="gst_amount form-control"
                                               id="gst_amount1">
                                    </td>
                                    <td style="vertical-align: top !important;text-align: center;">
                                        <input type="text" name="net_price[]" class="netprice form-control"
                                               id="net_price1">
                                    </td>
...
{{--                                        </div>--}}
                            ...
                            <table class="table table-striped add-edit-table table-bordered"
                                ...
                                <tr>
                                    <td colspan="11" style="text-align: right;">CGST Total (+)</td>
                                    <td colspan="2" style="text-align: right;"><input type="text"
                                ...
                                <tr>
                                    <td colspan="11" style="text-align: right;">SGST Total (+)</td>
                                    <td colspan="2" style="text-align: right;"><input type="text"
                                ...
                                <tr>
                                    <td colspan="11" style="text-align: right;">IGST Total (+)</td>
                                    <td colspan="2" style="text-align: right;"><input type="text"
                                    ...
                                    @foreach($product as $serarchprod)
                                        <tr value="{{$serarchprod->id}}">
                                            <td value="{{$serarchprod->id}}"
                                                style="width: 10%"><x-product-name :row="$serarchprod" /></td>
    ...
    <script type="text/javascript">
        ...
        function cal(ele) {
            ...
            var netprice = Number(afterdisc) + Number(gst_amount)+Number(sgst_amount)+Number(cgst_amount);
