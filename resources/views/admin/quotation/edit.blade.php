    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                {{Form::model($data,['method'=>'post','route'=>'post.quot_normal_update','role'=>'form','data-parsley-validate novalidate'])}}
                {{Form::hidden('id',null)}}
                                        ...
                                        <td style="vertical-align: top !important;width: 20%">
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-btn">
                                                    <button class="btn btn-default btnproductsearch"
                                                            onclick="product_search({{$srno}})">
