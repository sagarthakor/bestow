                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            <h4 class="page-title">Add New Manufacturer</h4>
                            <ol class="breadcrumb p-0 m-0">
                                ...
                                <li>
                                    <a href="{{url('item/manufacturer/list')}}">Manufacturer List </a>
                                </li>
                                <li class="active">
                                    Add Customer
                                </li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="row justify-content-md-center">
                                        {{Form::model($data,['method'=>'post','route'=>'post.manufacturer_update'])}}
                                        {{Form::hidden("id",null)}}
                                        <div class="col-md-12">
                                            <div class="demo-box">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Manufactured Name <span style="color: red">*</span></label>
