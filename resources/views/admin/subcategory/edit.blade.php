							...
							<div class="col-xs-12">
								<div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb p-0 m-0">
                                        ...
                                        <li>
                                            <a href="{{url('erp/subcategory/list')}}">Subcategory List </a>
                                        </li>
...
@endif
                                        <div class="col-xs-12">
                                            ...
                                            <div class="row">
                                                {{Form::model($data,['method'=>'post','route'=>'post.subcategory_update','files'=>'true'])}}
                                                {{ Form::hidden('id',null) }}
                                                <div class="col-md-12">
                                                    <div class="demo-box">
                                                        <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-12">
                                                          ...
                                                          <div class="form-group">
                                                                    ...
                                                                    <label>
                                                                        ...
                                                                        @else
                                                                        <img src="{{ asset('public/subcategory/'.$data->subcategory_image) }}" height="100" width="100">
                                                                        @endif
                                                                    </label>
                                                            </div>
