                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            <h4 class="page-title">Website Order </h4>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <table class="table table-borderless" style="border:0px !important">
                                        ...
                                        <tr>
                                            ...
                                            <td style="color: #222;width: 40%"> {{$data->customer_name}}</td>
                                            <td style="width: 20%">Order Date</td>
                                            <td style="color: #222;width: 20%">{{date('d-m-Y',strtotime($data->order_date))}}</td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" style="color: #222;"> {{$data->billing_address}}</td>
                                ...
                                <div class="tabledata">
                                                ...
                                                <td style="vertical-align: top !important;width: 20%">
                                                    ...
                                                    @if($item->custom_description !="")
                                                        <div class="form-group">
                                                            ...
                                                            <br>{{$item->custom_description}}
                                                        </div>
                                                    @endif
                                                </td>
                                                <td style="vertical-align: top !important;text-align: center;">
                                                    <a target="_blank" href="/product_image/{{$item->product_image}}">
                                                        <img src="/product_image/{{$item->product_image}}" style="height: 55px" width="55px"></a>
                                                </td>
                                                <td style="vertical-align: top !important;text-align: center;">
                                                    {{$item->qty}}
                                                </td>
                                    ...
                                    <table class="table table-striped add-edit-table table-bordered" style="margin-left: 62%;width: 38%;">
                                        <tr>
                                            <td colspan="10" style="text-align: right;">Item Total (+)</td><td style="text-align: right;">{{$data->net_amount ?? 0}}</td><td></td>
                                        </tr>

                                        <tr>
                                            <td colspan="10" style="text-align: right;">Discount Total (-)</td><td style="text-align: right;">{{$data->discount_total ?? 0}}</td><td></td>
                                        </tr>

                                        <tr>
                                            <td colspan="10" style="text-align: right;">CGST Total (+)</td><td style="text-align: right;">{{$data->cgsttotal ?? 0}}</td><td></td>
                                        </tr>
                                        <tr>
                                            <td colspan="10" style="text-align: right;">SGST Total (+)</td><td style="text-align: right;">{{$data->sgsttotal ?? 0}}</td><td></td>
                                        </tr>
                                        <tr>
                                            <td colspan="10" style="text-align: right;">IGST Total (+)</td><td style="text-align: right;">{{$data->gst_amount ?? 0}}</td><td></td>
                                        </tr>
                                        <tr>
                                            <td colspan="10" style="text-align: right;">Grand Total (+)</td><td style="text-align: right;">{{$data->grand_total ?? 0}}</td><td></td>
                                        </tr>
                                    </table>
                                </div>
