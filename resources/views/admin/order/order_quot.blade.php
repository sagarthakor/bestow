    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                {{Form::model($data,['method'=>'post','route'=>'post.order_quot_save','role'=>'form','data-parsley-validate novalidate'])}}
                {{Form::hidden("id",null)}}
                <div class="panel">
                                    ...
                                    <tr id="row{{$srno}}">
                                        <td style="vertical-align: top !important;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea style="width: 100%;" cols="1" rows="1" id="custom_description{{$srno}}" name="custom_description[]"
                                                          class="custom_description">{{$item->custom_description}}</textarea>
                                        ...
                                        <td style="vertical-align: top !important;text-align: center;">
                                            <img src="/product_image/{{$item->product_image}}" name="photo[]" style="height: 120px;width: 120px;" class="img-responsive photo">
                                        </td>
                                        <td style="vertical-align: top !important;text-align: center;">
                                        ...
                                        <td style="vertical-align: top !important;text-align: center;">
                                            <input type="text" class="uom smallInputBox inputElement" name="uom[]" value="{{$item->uom_name}}"
                                                   id="uom{{$srno}}">
                                        </td>

                                        <td style="vertical-align: top !important;">
                                            <div>
                                                <input oninput="cal(this)"  name="price[]" value="{{$item->pprice}}"
                                                       type="text"
