    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                {{Form::model($data,['method'=>'post','route'=>'admin.purchase.update','role'=>'form','data-parsley-validate novalidate'])}}
                {{Form::hidden('id',null)}}
                {{Form::hidden('pono',$data->pono)}}
                {{Form::hidden('purchase_no',$data->purchase_no)}}
     ...
     <span class="input-group-addon" id="start-date"><span class="glyphicon glyphicon-plus" style="cursor: pointer;" onclick="add_customer()"></span>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label">Purchase No. <span style="color: red">*</span></label>
                                    {{Form::text('purchase_no',null,['class'=>'form-control','autocomplete'=>'off'])}}
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {{Form::text('po_date',null,['class'=>'form-control input-daterange-datepicker','id'=>"quot_date",'autocomplete'=>'off'])}}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {{Form::text('due_date',null,['class'=>'form-control input-daterange-datepicker','id'=>"valid_until",'autocomplete'=>'off'])}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {{Form::text("vendor_po",null,["class"=>"form-control"])}}
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {{Form::select('status',$stage,null,['class'=>'form-control js-example-basic-single','id'=>'quot_stage'])}}
                                                    ...
                                                    <div class="form-group">
                                                        <select class="product listPrice smallInputBox inputElement js-example-basic-single"
                                                            ...
                                                            @foreach($product as $prod)
                                                                @php
                                                                    $variantLabel = trim(($prod->value1 ?? '') . ((($prod->value1 ?? '') !== '' && ($prod->value2 ?? '') !== '') ? ' / ' : '') . ($prod->value2 ?? ''));
                                                                @endphp
                                                                <option value="{{$prod->id}}">{{$prod->item_code}} - {{$prod->product_name}}{{ $variantLabel !== '' ? ' ('.$variantLabel.')' : '' }}</option>
                                                            @endforeach
                                                        </select>
...
{{--                                                </td>--}}
                                    ...
                                    <table class="table table-striped add-edit-table table-bordered"
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" style="text-align: right;"><input type="text"
                                                                                              ...
                                                                                              name="discount_total"
                                                                                              id="discount_total" value="{{$data->discount_total}}">
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" style="text-align: right;"><input type="text"
                                                                                              ...
                                                                                              value="{{$data->igsttotal}}"></td>
                                        </tr>
                                        <tr>
                                            <td colspan="11" style="text-align: right;">Adjustment</td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" style="text-align: right;"><input type="text"
                                                                                              ...
                                                                                              name="grand_total"
                                                                                              id="grand_total" value="{{$data->grand_total}}"></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
    ...
    function get_product(ele) {
        ...
        if(customer==""){
           ...
           $(ele).closest('tr').find('.description').val("");
            ...
            $.ajax({
                url: appurl + '/admin/purchase/get_product',
       ...
       var customer = $("#customer").val();
        if(customer==""){
           ...
           $(ele).closest('tr').find('.description').val("");
            ...
            $.ajax({
                url: appurl + '/purchase/get_product',
                data: {product: product,customer:customer},
                method: 'get',
                dataType: 'json',
                success: function (data) {
   ...
   function discmatcal(ele)
    ...
    $("#add_product").click(function (e) {
            ...
            var data = "<tr id='row" + i + "'><td style='width:35%'><div class='form-group'><select class='form-control js-example-basic-single product' onchange='get_product(this)' name='product[]' id='product" + i + "'> <option>select</option>@foreach($product as $prod)@php($variantLabel = trim(($prod->value1 ?? '') . ((($prod->value1 ?? '') !== '' && ($prod->value2 ?? '') !== '') ? ' / ' : '') . ($prod->value2 ?? '')))<option value='{{$prod->id}}'>{{$prod->item_code}} - {{$prod->product_name}}{{ $variantLabel !== '' ? ' ('.$variantLabel.')' : '' }}</option>@endforeach</select></div><div class='form-group'><label></label><textarea style='width:100%' id='description" + i + "' name='description[]' class='description'></textarea></div></td>";
