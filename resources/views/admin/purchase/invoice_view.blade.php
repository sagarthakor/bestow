     ...
     <div class="card-box table-responsive">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                @if($po_data->invoice_date)
                                {{date('d-m-Y',strtotime($po_data->invoice_date))}}
                                @endif
                            </div>
                        </div>
                        
                        @if($po_data->invoice_file)
                        <div class="col-md-12">
                            <iframe src="{{asset('public/po/invoice_file/'.$po_data->invoice_file)}}" width="1000" height="1000"></iframe>
                        </div>
                        @endif
