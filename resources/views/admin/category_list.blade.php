                                    ...
                                    <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
                                        ...
                                        <tbody>
                                            ...
                                            <td class="actions" style="width: 10%">
                                             @can('product_update')
                                                    <a href="{{route('admin.category.edit',['id' => $list->id] )}}" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
                                             @endcan
                                            @can('product_delete')
                                                     <a href="{{route('admin.category.delete',['id' => $list->id] )}}" class="on-default remove-row" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"></i></a>
                                            @endcan
