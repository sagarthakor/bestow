...
<head>
    ...
    <!-- App title -->
    <title>{{Session::get('software_title')}} - Purchase Edit</title>
    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                {{Form::model($data,['method'=>'post','route'=>'post.po_update','role'=>'form','data-parsley-validate novalidate'])}}
                {{Form::hidden('id',null)}}
     ...
     <span class="input-group-addon" id="start-date"><span class="glyphicon glyphicon-plus" style="cursor: pointer;" onclick="add_customer()"></span>
                        ...
                        <div class="tabledata">
                                ...
                                @foreach($quotitem as $item)
                                    ...
                                    <tr id="row{{$srno}}">
                                        ...
                                        <td style="vertical-align: top !important;text-align: center;">
                                            <input type="text" class="form-control" name="inner_diamitter[]" value="{{$item->inner_diameter}}" id="inner_diamitter{{$srno}}" style="text-align: center;">
                                        </td>
                                        <td style="vertical-align: top !important;text-align: center;">
                                            <input type="text" class="form-control" name="outer_diamitter[]" value="{{$item->outer_diameter}}" id="outer_diamitter{{$srno}}" style="text-align: center;">
                                        </td>
                                        <td style="vertical-align: top !important;text-align: center;">
                                            <input type="text" class="form-control" name="thikness[]" value="{{$item->thikness}}" id="thikness{{$srno}}">
                                        </td>
                                        <td style="vertical-align: top !important;text-align: center;">
                                            <input type="text" class="form-control" name="hsn[]" value="{{$item->hsn}}" id="hsn{{$srno}}">
                                        </td>
                                        <td style="vertical-align: top !important;text-align: center;">
                            ...
                            <table class="table table-striped add-edit-table table-bordered" style="margin-left: 62%;width: 38%;">
                                <tr>
                                    <td colspan="10" style="text-align: right;">Item Total (+)</td><td style="text-align: right;"><input type="text" class="form-control item_total" name="item_total" id="item_total" value="{{$data->net_amount}}"></td><td></td>
                                </tr>

                                <tr>
                                    <td colspan="10" style="text-align: right;">Discount Total (-)</td><td style="text-align: right;"><input type="text" class="form-control discount_total" name="discount_total" id="discount_total" value="{{$data->discount_total}}"></td><td></td>
                                </tr>

                                <tr>
                                    <td colspan="10" style="text-align: right;">GST Total (+)</td><td style="text-align: right;"><input type="text" class="form-control gsttotal" name="gsttotal" id="gsttotal" value="{{$data->gst_amount}}"></td><td></td>
                                </tr>
                                <tr>
                                    <td colspan="10" style="text-align: right;">Grand Total (+)</td><td style="text-align: right;"><input type="text" class="form-control grand_total" name="grand_total" id="grand_total" value="{{$data->grand_total}}"></td><td></td>
                                </tr>
                            </table>
                        </div>
