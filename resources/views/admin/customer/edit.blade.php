                                            ...
                                            <div class="demo-box">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        {{Form::number('owner_mobile',null,['class'=>'form-control'.$errors->first('owner_mobile',' error')])}}
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        {{Form::number('alternate_no',null,['class'=>'form-control'.$errors->first('alternate_no',' error')])}}
