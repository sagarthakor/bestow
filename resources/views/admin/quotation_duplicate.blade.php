            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden"  name="quotid" value="{{$data->id}}">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Followup Date</label>
                                {{Form::date('followup_date',date('Y-m-d'),['class'=>'form-control'.$errors->first('followup_date',' error'),'autocomplete'=>'off','id'=>'followups_date'])}}
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {{Form::date('next_followup_date',null,['class'=>'form-control'.$errors->first('next_followup_date',' error'),'autocomplete'=>'off','id'=>'next_followups_date'])}}
