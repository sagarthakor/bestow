...
<body class="fixed-left">
        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container">
                    ...
                    {{Form::model($data,['method'=>'post','route'=>'post.so_update'])}}
                    {{Form::hidden('id',null)}}
    ...
    <!--   <div class="col-sm-6">
                             ...
                             <tfoot>
                                ...
                                <tr>
                                    <td colspan="7" style="text-align: right;">GST Total</td><td style="text-align: right;">{{$data->gst_amount}}</td><td></td>
                                </tr>
                                <tr>
                                    <td colspan="7" style="text-align: right;">Grand Total</td><td style="text-align: right;">{{$data->grand_total}}</td><td></td>
                                </tr>
                            </tfoot>
                        </table>
