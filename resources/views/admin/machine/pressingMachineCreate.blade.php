                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            <h4 class="page-title">Pressing Machine Add </h4>
                            <ol class="breadcrumb p-0 m-0">
                                <li>
                                    <a href="{{ url('admin') }}">{{Session::get('software_title')}}</a>
                                </li>
                                <li>
                                    <a href="{{url('pressing-machine/list')}}">Pressing Machine List </a>
                                </li>
                                <li>
                                    Add New Machine
                                </li>
                        ...
                        <div class="card-box">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="row">
                                        {{Form::open(['method'=>'post','route'=>'post.pressingmachine_save','files'=>'true'])}}
                                        <div class="col-md-12">
                                            <div class="demo-box">
                                                <div class="col-md-12">
