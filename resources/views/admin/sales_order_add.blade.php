...
<head>
    ...
    <!-- App title -->
    <title>{{Session::get('software_title')}} - Creating New Sales Order</title>
        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container">
                    ...
                    {{Form::model($data,['method'=>'post','route'=>'post.so_save'])}}
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="tabledata">
                                            ...
                                            <tr id="row{{$srno}}">
                                                <td style="vertical-align: top !important;width: 30%">
                                                  <div class="input-group">
                                                   <select class="form-control" onchange="get_product(this.value,1)" name="product[]" id="product{{$srno}}">
                                 ...
                                 <td style="vertical-align: top !important;text-align: center;">
                                     <input type="text" class="form-control" name="thikness[]" value="{{$item->thikness}}" id="thikness{{$srno}}" style="text-align: center;width: 45px">
                                 </td> -->
                                 <td style="vertical-align: top !important;text-align: center;">
                                ...
                                <td class="actions" style="vertical-align: top !important;text-align: center;">
                                    ...
                                    <!--  <a href="#" class="on-editing cancel-row"><i class="fa fa-times"></i></a> -->
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                <td colspan="9" style="text-align: right;">Item Total</td>
                                                <td style="text-align: right;" colspan="2"><input type="text" class="form-control item_total" name="item_total" id="item_total" value="{{$data->net_amount}}"></td>
                                            </tr>
                                            <tr>
                                                <td colspan="9" style="text-align: right;">Discount Total (-)</td>
                                            ...
                                            <tr>
                                                <td colspan="9" style="text-align: right;">GST Total</td>
                                                <td colspan="2" style="text-align: right;"><input type="text" class="form-control gsttotal" name="gsttotal" id="gsttotal" value="{{$data->gst_amount}}"></td>
                                            </tr>
                                            <tr>
                                                <td colspan="9" style="text-align: right;">Grand Total</td>
                                                <td style="text-align: right;" colspan="2"><input type="text" class="form-control grand_total" name="grand_total" id="grand_total" value="{{$data->grand_total}}"></td>
                                            </tr>
                                        </tfoot>
                                    </table>
