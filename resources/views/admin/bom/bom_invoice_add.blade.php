        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container">
                    ...
                    {{Form::open(['method'=>'post','route'=>'post.quot_save','role'=>'form','data-parsley-validate novalidate'])}}
                                        ...
                                        <tbody>
                                            ...
                                            if(empty($str))
                                            {
                                                ...
                                                <tr class="gradeX" id="row1">
                                                    <td style="width: 20%">
                                                        <div class="input-group">
                                                         <select onchange="get_product(this.value,1)" name="product[]" id="product1" class="form-control" required>
                                            ...
                                            <td style="vertical-align: top !important;text-align: center;">
                                               <input type="text"  name="inner_diamitter[]" id="inner_diamitter1" class="form-control">
                                           </td>
                                           <td style="vertical-align: top !important;text-align: center;">
                                               <input type="text" name="outer_diamitter[]" id="outer_diamitter1" class="form-control">
                                           </td>
                                           <td style="vertical-align: top !important;text-align: center;">
