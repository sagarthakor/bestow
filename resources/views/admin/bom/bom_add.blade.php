                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="page-title-box">
                                <h4 class="page-title">BOM Add </h4>
                                                ...
                                                <div class="demo-box">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            {{Form::text('bom_name',null,['required','class'=>'form-control'.$errors->first('bom_name',' error')])}}
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            {{Form::select('bom_category',$category,null,['required','class'=>'form-control js-example-basic-single','id'=>'category'])}}
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            {{Form::select('bom_material',$material,null,['class'=>'form-control js-example-basic-single','id'=>'material','onchange'=>'gethsn()'])}}
...
{{--                                                            {{Form::text('bom_inner_diameter',null,['class'=>'form-control'])}}--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
...
{{--                                                            {{Form::text('bom_outer_diameter',null,['class'=>'form-control'])}}--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
...
{{--                                                            {{Form::text('bom_thikness',null,['class'=>'form-control'])}}--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            {{Form::text('bom_hsn',null,['class'=>'form-control','id'=>'hsn'])}}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3" >
                                                        <div class="form-group">
                                                            ...
                                                            {{Form::text('bom_price',null,['required','class'=>'form-control','placeholder'=>'unit price'])}}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            {{Form::select('bom_gst',$gst,null,['class'=>'form-control js-example-basic-single'])}}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="control-label">UOM</label>
                                                            {{Form::select('bom_uom',$uom,null,['class'=>'form-control js-example-basic-single'])}}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3" >
                                                     ...
                                                     <div class="col-md-12">
                                                            <div class="row">
                                                                <div class="tabledata">
                                                                    <table class="table table-striped add-edit-table table-bordered" id="caltable1">
                                                                        <thead>
                                                                        <tr>
                                                                        ...
                                                                        <tr class="gradeX" id="row1">
                                                                            <td>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <select onchange="getvariation(this)" class="form-control attribute" name="attribute1" id="attribute1">
                                                                            ...
                                                                            <td>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <select class="form-control attribute_value" name="value1" id="value1">
                                                                        ...
                                                                        <tr class="gradeX" id="row1">
                                                                            <td>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <select onchange="getvariation(this)" class="form-control attribute" name="attribute2" id="attribute2">
                                                                            ...
                                                                            <td>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <select class="form-control attribute_value" name="value2" id="value2">
...
{{--                                                                <th style="text-align: center;">THK</th>--}}
                              ...
                              <tr>
                                <td colspan="11" style="text-align: right;display:none">Item Total (+)</td>
                                <td colspan="2" style="text-align: right;display:none"><input type="text" class="form-control item_total" name="item_total" id="item_total" value="0"></td>
                            </tr>
...
<br>                                                            {{Form::textarea('bom_description',null,['class'=>'',"style"=>"width:100%",'cols'=>'2','rows'=>'2'])}}
                                                        </div>
                                                    </div>
...
//alert(attribute1);
getvariation1(attribute1);
var attribute2=$("#attribute2").val();
getvariation2(attribute2);
    $('form').parsley();
                    // /getdate("Sd");
                });
 $(function () {
    ...
    $(ele).closest('tr').find('.discount_amount').val(discount_amount);
        ...
        <script>
            ...
            $("#add_product").click(function(e){
                ...
                data +='<td style="vertical-align: top !important;text-align:center"><input type="text" name="qty[]" value="1" oninput="cal(this)" class="qty form-control" id="qty'+i+'"><label class="stockQty">Stock : </label><input type="hidden" class="stock"></td>';

                data +='<td style="vertical-align: top !important;text-align:center"><input type="text" name="uom[]" oninput="cal(this)" class="uom form-control" id="uom'+i+'"></td>';

                data +='<td style="vertical-align: top !important;text-align:center;display:none"><input type="text" name="price[]" class="price form-control" id="price'+i+'" oninput="cal(this)"></td>';

                data +='<td style="vertical-align: top !important;text-align:center;display:none"><input type="text" name="amount[]" class="total form-control" id="total'+i+'" oninput="cal(this)"></td>';
