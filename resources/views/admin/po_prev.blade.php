...
<page size="A4">
    ...
    <table>
        ...
        <tr>
            ...
            <td colspan="9" style="text-align: right; border-left:none;vertical-align: top;">
                <table style="border: none;">
                    <tr> <td style="border: none;width:50%;text-align: left">
                            <img src="{{asset('public/company_logo/'.$company->logo)}}" height="135px"></td>
                        <td style="border: none;border-left:none;vertical-align: top;padding-left: 18px">
                            ...
                            <p style="margin:0px;line-height:15px;font-size:12px;text-align: right;" >{{strip_tags($company->address)}}</span></p></td></tr>
        ...
        <tr>
            <td colspan="9" style="text-align: center;"><h2>Purchase Order</h2></td>
        </tr>
        <tr>
            <td colspan="2" style="border: none;vertical-align: top;border-right: none;">
                <table style="border: none;">
                    <tr>
                        <td style="border: none;"><b>Bill To,<br><span style="font-size: 10px;margin-top: 5px">M/s. {{$vendor->vendor_name}}</span></b><br>{{strip_tags($vendor->billing_address)}}<br>Mobile :- {{$vendor->primary_phone}}, Email :- {{$vendor->primary_email}}<br>GSTIN :- {{$vendor->owner_gst}}</td>
                    </tr>

                </table>
            </td>

            <td colspan="7" style="vertical-align: top;font-size: 10px !important;border-left: none;text-align: right;">
                <table style="border: none;">
                    <tr style="border: none;">
                        <td style="border: none; font-weight: bold;text-align: right;">Purchase No. :</td>
                        <td style="border: none;text-align: right;">{{$po->purchase_no}}</td>
                    </tr>
                    <tr style="border: none;">
                        <td style="border: none;font-weight: bold;text-align: right;">Purchase Date :</td>
                        <td style="border: none;text-align: right;">{{date('d-m-Y',strtotime($po->po_date))}}</td>
                    </tr>
                    <tr style="border: none;">
                        <td style="border: none;font-weight: bold;text-align: right;">Sales Order No. :</td>
                        <td style="border: none;text-align: right;">{{$po->salesorder_no}}</td>
                    </tr>
                    <tr style="border: none;">
                        <td style="border: none;font-weight: bold;text-align: right;">Contact Name :</td>
                        <td style="border: none;text-align: right;">{{$po->contact_name}}</td>
                    </tr>
                    <tr style="border: none;">
                        <td style="border: none;font-weight: bold;text-align: right;">Contact No :</td>
                        <td style="border: none;text-align: right;">{{$po->primary_phone}}</td>
                    </tr>
        ...
        @else
            <tr>
                ...
                <td colspan="8" style="text-align: right;"><b>DISCOUNT TOTAL (-)</b></td>
                <td colspan="1" style="text-align: right;"><b><?=number_format($discount,2,'.',',');?></b></td>
            </tr>
        @endif
        <tr>
            <!-- <td colspan="4" style="text-align: center;letter-spacing: 1px;font-size: 13px"></td> -->
            <td colspan="8" style="text-align: right;"><b>GST TOTAL (+)</b></td>
        ...
        <tr>
            <td colspan="9"><div class="footer">Purchase Order Prepared By : {{$po->user_name}}</div></td>
        </tr>
        </tbody>
    </table>
</page>
