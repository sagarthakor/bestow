...
<div class="footer">
   ...
   <span style="text-align: left !important;font-weight: 600">Quote Prepared By : {{$data->first_name}} {{$data->last_name}}</span>
...
<body>
	...
	<table>
			...
			<tr>
				<td colspan="{{ $totcol }}" style="text-align: center;"><h2>Sales Order</h2></td>
			</tr>
			<tr>
				<td colspan="{{ $totdivide }}" style="border: none;vertical-align: top;border-right: none;">
				    <table style="border: none;">
				        <tr>
				...
				<td colspan="{{ $totdivide1 }}" style="vertical-align: top;font-size: 10px !important;border-left: none;text-align: right;">
					<table style="border: none;">
			...
			<tr>
				...
				<td style="text-align: left;vertical-align:top;width:60%"><x-product-name :row="$item" print />
                    <br>
                    <span style="font-size: 8px">{{$item->description}}</span>
                </td>

            <td style="text-align: center;vertical-align:top;">{{$item->inner_daimitter}}</td>
            <td style="text-align: center;vertical-align:top;">{{$item->outer_daimitter}}</td>
            <td style="text-align: center;vertical-align:top;">{{$item->thk}}</td>
