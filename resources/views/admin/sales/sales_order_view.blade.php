            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            <h4 class="page-title">Salesorder </h4>
                            <ol class="breadcrumb p-0 m-0">
                                ...
                                <li>
                                    <a href="{{url('client/salesorder/list')}}">Sales List </a>
                                </li>
                                <li>
                                    Salesorder View
                                </li>
                ...
                <ul class="nav nav-tabs">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        @can('sales_update')
                            <li><a href="{{url('client/so_edit/'.$data->id)}}"><span
                                        class="glyphicon glyphicon-user"></span>Edit</a></li>
                        @endcan
                    </ul>
                </ul>
                                ...
                                <div class="tabledata">
                                        ...
                                        @foreach($quotitem as $item)
                                            ...
                                            <tr id="row{{$srno}}">
                                                ...
                                                <td style="vertical-align: top !important;text-align: center;">
                                                    <img src="{{asset('public/product_image/'.$item->product_image)}}" name="photo[]" style="height: 120px;width: 120px;" class="img-responsive photo">
                                                </td>
                                                <td style="vertical-align: top !important;text-align: center;">
                                                    {{$item->hsn}}
                                                </td>
                                    ...
                                    <table class="table table-striped add-edit-table table-bordered"
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: right;">{{$data->cgstamount ?? 0}}</td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td colspan="10" style="text-align: right;">SGST Total (+)</td>
                                            <td style="text-align: right;">{{$data->sgstamount ?? 0}}</td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td colspan="10" style="text-align: right;">IGST Total (+)</td>
                                            <td style="text-align: right;">{{$data->gst_amount ?? 0}}</td>
                                            <td></td>
                                        </tr>
