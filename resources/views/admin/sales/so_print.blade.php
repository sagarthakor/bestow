...
<div class="footer">
    ...
    <span style="text-align: left !important;font-weight: 600">Sales Order By : {{$quot->first_name}} {{$quot->last_name}}</span>
...
<table style="border: none">
    <tr>
        ...
        <td style="width: 35%;vertical-align: top;border: none;padding: 15px">
            ...
            <table align="center" style="width: 100%">
                <tr>
                    <th colspan="2">SONO. : {{$quot->salaesorder_no}}</th>
                </tr>
                <tr>
                    <td style="text-align: left;border-right: none;width: 40%"><b>Issued Date</b> </td>
                    <td style="border-left: none;text-align: left;width: 60%"> : {{date('d-m-Y',strtotime($quot->salaesorder_date))}}</td>
                </tr>
                <tr>
                    <td style="text-align: left;border-right: none"><b>Valid Date</b> </td><td style="border-left: none;text-align: left"> : {{date('d-m-Y',strtotime($quot->due_date))}}</td>
                </tr>
            </table>
...
{{--            </td>--}}
            ...
            <td style="text-align: right;vertical-align:top;width: 3%">{{number_format($item->total,2,'.',',')}}</td>
...
{{--                <td style="text-align: right;vertical-align:top;width: 3%">{{$item->gst_amount}}</td>--}}
    ...
    @if($totcgst !="" || $totcgst != 0)
        <tr>
            ...
            <td style="text-align: right">{{number_format($quot->cgstamount,2,'.',',')}}</td>
        </tr>

        <tr>
            <td style="text-align: left" colspan="10">SGST</td>

            <td style="text-align: right">{{number_format($quot->sgstamount,2,'.',',')}}</td>
        </tr>
    @else
        <tr>
            <td style="text-align: left" colspan="10">IGST</td>

            <td style="text-align: right">{{number_format($quot->gst_amount,2,'.',',')}}</td>
        </tr>
    @endif
    <?php
