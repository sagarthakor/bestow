    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                {{Form::model($data,['method'=>'post','route'=>'post.so_duplicate'])}}
                {{Form::hidden('id',null)}}
                                        ...
                                        <td style="vertical-align: top !important;width:35%">
                                            <div class="form-group">
                                                <select class="product listPrice smallInputBox inputElement js-example-basic-single"
                                                    ...
                                                    <option value="{{$item->product}}">{{$item->item_code}} - {{ \App\product::nameWithVariantInline($item->product_name, $item->value1 ?? null, $item->value2 ?? null) }}</option>
...
{{--                                        </td>--}}
                                        ...
                                        <td style="vertical-align: top !important;text-align: center;width: 10%">
                                            ...
                                            <label class="stockQty">Stock : {{$item->stockqty ?? 0}}</label>
                                        </td>
                                        <td style="vertical-align: top !important;text-align: center;">
