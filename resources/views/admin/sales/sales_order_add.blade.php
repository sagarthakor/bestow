    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                    ...
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            ...
                            <ol class="breadcrumb p-0 m-0">
                                ...
                                <li>
                                    <a href="{{url('client/salesorder/list')}}">Sales Order List </a>
                                </li>
                                <li class="active">
                ...
                {{Form::model($data,['method'=>'post','route'=>'admin.sales.save'])}}
                        ...
                        <!-- <div class="col-md-4" style="display: none;" id="qno">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{Form::text('quot_date',null,['class'=>'form-control input-daterange-datepicker','id'=>"quot_date"])}}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">Sales Order Date <span
                                            style="color: red">*</span></label>
                                    {{Form::text('salaesorder_date',date('d-m-Y'),['required','class'=>'form-control input-daterange-datepicker','id'=>"salaesorder_date",'autocomplete'=>'off'])}}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{Form::text('purchase_order',null,['class'=>'form-control','id'=>"purchase_order"])}}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{Form::text('purchase_order_date',null,['class'=>'form-control input-daterange-datepicker','id'=>"purchase_order_date"])}}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    ?>
                                    {{Form::select('status',$stage,null,['class'=>'form-control js-example-basic-single'])}}
                                </div>
                            </div>
                                ...
                                <div class="tabledata table-responsive">
                                    <table class="table table-striped table-bordered" id="caltable">
                                        ...
                                        @foreach($quotitem as $item)
                                            ...
                                            <tr id="row{{$srno}}">
                                                ...
                                                <td style="vertical-align: top !important;width:35%">
                                                    <div class="form-group">
                                                        <select class="product listPrice smallInputBox inputElement js-example-basic-single"
                                                            ...
                                                            @endphp
                                                            <option value="{{$item->product}}">{{$item->item_code}} - {{$item->product_name}}{{ $itemVariantLabel !== '' ? ' ('.$itemVariantLabel.')' : '' }}</option>
                                                            @foreach($product as $prod)
                                                                @php
                                                                    $prodVariantLabel = trim(($prod->value1 ?? '') . ((($prod->value1 ?? '') !== '' && ($prod->value2 ?? '') !== '') ? ' / ' : '') . ($prod->value2 ?? ''));
                                                                @endphp
                                                                <option value="{{$prod->id}}">{{$prod->item_code}} - {{$prod->product_name}}{{ $prodVariantLabel !== '' ? ' ('.$prodVariantLabel.')' : '' }}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                {{--                                                           class="smallInputBox inputElement inner_diameter" value="{{$item->inner_diameter}}">--}}
                                                {{--                                                </td>--}}
                                                {{--                                                <td style="width:6%;vertical-align: top !important;text-align: center;">--}}
                                                {{--                                                    <input type="text" name="outer_diamitter[]" id=""--}}
                                                {{--                                                           class="smallInputBox inputElement outer_diameter" value="{{$item->outer_diameter}}">--}}
                                                {{--                                                </td>--}}
                                                {{--                                                <td style="width:6%;vertical-align: top !important;text-align: center;">--}}
                                                ...
                                                <td style="vertical-align: top !important;text-align: center;width: 10%">
                                                    ...
                                                    <label>Stock : {{$item->stockqty ?? 0}} <span class="uomSpan">{{$item->uom_name}}</span></label>
                                                </td>
                                                <td style="vertical-align: top !important;text-align: center;">
                                                ...
                                                <td style="vertical-align: top !important;">
                                                    <input type="hidden" class="total" value="{{$item->amount}}" name="total_amount[]">
                                    ...
                                    <table class="table table-striped add-edit-table table-bordered"
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: right;" colspan="2"><input type="text"
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" style="text-align: right;"><input type="text"
                                                                                              ...
                                                                                              name="discount_total"
                                                                                              id="discount_total" value="{{$discamt ?? "0"}}">
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" style="text-align: right;"><input type="text"
                                                                                              class="form-control gsttotal"
                                                                                              name="gsttotal" id="gsttotal"
                                                                                              value="{{$data->gst_amount ?? "0"}}">
                                            </td>
                                        </tr>
                                        <tr>
