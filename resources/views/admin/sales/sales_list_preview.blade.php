        ...
        <div class="card-box table-responsive">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <td> <button class="btn btn-brown">
                            <i class="mdi mdi-file-find"></i>Search</button></td>
                </tr>
                </thead>
                ...
                @foreach($list as $data)
                    ...
                    <tr>
                        ...
                        <td width="12%" style="vertical-align: top;">
                            <a target="_blank" href="{{url('client/sales1/view/'.$data->id)}}">{{$data->salaesorder_no}}</a>
                        </td>
                        ...
                        <td style="vertical-align: top;text-align: center;">
                            @if($data->deliverychallan_status=="Y")
                                <i style="color: green" class="mdi mdi-check" aria-hidden="true">Done</i>
                            @else
                                <a target="_blank" title="Delivery Challan" href="{{url('sales/deliverychallan/add/'.$data->id)}}"><i class="mdi mdi-cart"></i>Create</a>
                            @endif
                        </td>
                    ...
                    <!--    @if($data->invoice_status=="Y")-->
                        ...
                        <!--    @else-->
                    <!--    <a href="{{url("sales/invoice/add/".$data->id)}}">Add</a>-->
                        <!--    @endif-->
                        <!--</td>-->
                        <td style="vertical-align: top;">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    @can('sales_update')
                                        <li><a title="Edit" target="_blank" href="{{url('client/so_edit/'.$data->id)}}">Edit</a></li>
                                    @endcan

                                    @can('sales_print')
                                        <li><a target="_blank" title="View" href="{{url('client/so_preview/'.$data->id)}}">View</a></li>

                                        <li><a target="_blank" title="Print" href="{{url('client/so_print/'.$data->id)}}">Pint</a></li>
                                    @endcan
                                </ul>
                            </div>
