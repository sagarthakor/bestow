...
<head>
    ...
    <!-- App title -->
    <title>{{Session::get('software_title')}} - Quotation List</title>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4" style="text-align: right;margin-bottom: 5px">
                        <a class="btn btn-primary" href="{{url('client/quotaion/normal/add')}}">Add New</a>
                    </div>
                </div>
                <div class="row">
                                ...
                                @foreach($list as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td width="12%"  style="vertical-align: top;">
                                            <a href="{{url('client/quot/normal/view/'.$data->id)}}">{{$data->quotation_no}}</a></td>
                                        ...
                                        <td  style="vertical-align: top;width: 15%">
                                            @can('quotation_update')
                                                <a class="table-btn" title="edit"  href="{{url('client/quot/normal/edit/'.$data->id)}}"title="edit"><i class="fa fa-pencil" style="margin:10px;font-size: 10px;"></i></a>
                                            @endcan
