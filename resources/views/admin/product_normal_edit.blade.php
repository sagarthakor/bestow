...
@endif
                                        <div class="col-xs-12">
                                            ...
                                            <div class="row">
                                                {{Form::model($data,['method'=>'post','route'=>'post.product_normal_update','files'=>'true'])}}
                                                {{Form::hidden('id',null)}}
                                                <div class="col-md-12">
                                                    <div class="demo-box">
                                                        <div class="col-md-4">
                                                       ...
                                                       <div class="col-md-6">
                                                         ...
                                                         <div class="col-md-6">
                                                          <div class="form-group">
                                                                    ...
                                                                    @else
                                                                   <label><img height="65px" width="65px" src="{{asset('public/product_image/'.$data->product_image)}}"  id="myImg"></label>
                                                                    @endif
                                                            </div>
                                                        </div>
