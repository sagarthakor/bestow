                    ...
                    <div class="row">
                     <div class="col-xs-12">
                        <div class="page-title-box">
                            <h4 class="page-title">Add New Vendor Contact</h4>
                            <ol class="breadcrumb p-0 m-0">
                                <li>
                                    <a href="#">{{Session::get('software_title')}}</a>
                                </li>
                                <li>
                                    <a href="{{url('client/vendor/contact')}}">Vendor Contact List </a>
                                </li>
                                             ...
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::text('contact_name',null,['class'=>'form-control'. $errors->first('contact_name', ' error')])}}
                                                     @if ($errors->has('contact_name')) <p class="help-block">This field is required</p> @endif
                                                </div>
                                            </div>
                                              ...
                                              <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::select('vendor',$vendor,null,['class'=>'form-control'. $errors->first('vendor', ' error')])}}
