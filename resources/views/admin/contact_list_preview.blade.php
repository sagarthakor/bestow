                        ...
                        <div class="table-responsive">
                              ...
                              <tbody>
                                ...
                                @foreach($cdata as $data)
                                    <?php $srno++; ?>
                                    <tr> <td
                                style="width: 2%"> {{$srno}}</td> <td
                                style="vertical-align: top;"><a
                                href="{{url('client/contact/view/'.$data->id)}}"
                                target="_blank">{{$data->contact_name}}</a></td>
                                    <td  style="vertical-align:
                                top;">{{$data->primary_phone}}</td>
                                    <td  style="vertical-align:
                                top;">{{$data->primary_email}}</td>
                                <td  style="vertical-align:
                                top;">{{$data->customer_name}}</td> <td
                                style="vertical-align:
                                top;">{{$data->department}}</td> <td
                                style="vertical-align:
                                top;">{{$data->designation}}</td>
