                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Create New Raw Material  </h4>
...
@endif
                                        <div class="col-xs-12">
                                            ...
                                            <div class="row">
                                                {{Form::open(['method'=>'post','route'=>'post.raw_material_save','files'=>'true'])}}
                                                <div class="col-md-12">
                                                    <div class="demo-box">
                                                        
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label class="control-label">Raw Material Group <span style="color:red"> *</span></label>
                                                                {{Form::select('raw_material_group',$raw_material_group,null,["required",'class'=>'form-control'])}}
                                                            </div>
                                                        </div>
