                ...
                <div class="row">
                    ...
                    @can('invoice_create')
                        <div class="col-sm-4" style="text-align: right;margin-bottom: 5px">
                            <a class="btn btn-primary" href="{{ route('sales.invoice.add',['id' => 0]) }}">Add New</a>
                        </div>
                    @endcan
                </div>
                <div class="row">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                @foreach($list as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td  style="vertical-align: top;width:7%;text-align: left;"> {{number_format($data->grand_total + $data->cgsttotal + $data->sgsttotal + $data->igsttotal + $data->adjustment)}}</td>
                                        ...
                                        <td  style="vertical-align: top;">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    @can('invoice_update')
                                                        <li>
                                                            <a href="{{route('admin.invoice.edit',['id' => $data->id])}}" title="edit">
                                                                Edit
                                                            </a>
                                                        </li>
                                                    @endcan
                                                    @can('invoice_view')
                                                            {{--<li>
                                                                <a target="_blank" href="{{route('admin.invoice.preview',['id' => $data->id] )}}" title="View">
                                                                    View
                                                                </a>
                                                            </li>--}}
                                                    @endcan
                                                    ...
                                                    @can('invoice_print')
                                                            <li>
                                                        <a href="{{route('admin.invoice.print',['id' => $data->id] )}}" title="Print">
                                                                    Print
                                                                </a>
                                                            </li>
                                                    @endcan
                                                    @can('invoice_delete')
                                                            <li>
                                                                <a href="{{route('admin.invoice.delete',['id' => $data->id] )}}" title="Print">
                                                                    Delete
                                                                </a>
                                                            </li>
                                                    @endcan
