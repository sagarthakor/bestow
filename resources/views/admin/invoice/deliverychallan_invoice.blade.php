                        ...
                        <!-- <div class="col-md-4" style="display: none;" id="qno">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{Form::text('invoice_number',$invoice_no,['required','class'=>'form-control input-daterange-datepicker','autocomplete'=>'off'])}}
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{Form::text('delivery_date',date('d-m-Y'),['class'=>'form-control input-daterange-datepicker','id'=>"delivery_date",'autocomplete'=>'off'])}}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{Form::text('eway_billdate',null,['class'=>'form-control input-daterange-datepicker','id'=>"eway_billdate",'autocomplete'=>'off'])}}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{Form::text('vc_no',null,['class'=>'form-control','autocomplete'=>'off'])}}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php
                                    $arr=array(''=>'select Stage','Created'=>'Created','Approved'=>'Approved','Delivered'=>'Delivered','Cancelled'=>'Cancelled');
                                    ?>
...
{{--                                            </td>--}}
                                            ...
                                            <td style="vertical-align: top !important;text-align: center;width: 10%">
                                                <input type="text" readonly name="qty[]" onkeyup="cal(this)" value="{{$item->qty}}"
