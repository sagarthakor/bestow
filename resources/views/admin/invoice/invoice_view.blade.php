            ...
            <div class="container">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        @can('invoice_update')
                            <li><a href="{{url('invoice/edit/'.$data->id)}}"><span
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label for="staticEmail" class="col-sm-6 col-form-label">Payment Due Date.</label>
                                            <div class="col-sm-6">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label for="staticEmail" class="col-sm-6 col-form-label">Invoice Number.</label>
                                            <div class="col-sm-6">
                                                {{$data->invoice_number}}
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label for="staticEmail" class="col-sm-6 col-form-label">Delivery Date.</label>
                                            <div class="col-sm-6">
                                                {{$data->delivery_date}}
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label for="staticEmail" class="col-sm-6 col-form-label">E Way Bill No.</label>
                                            <div class="col-sm-6">
                                                {{$data->eway_billno}}
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label for="staticEmail" class="col-sm-6 col-form-label">E Way Bill Date</label>
                                            <div class="col-sm-6">
                                                {{$data->eway_billdate}}
                                            </div>
                                        </div>
