                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="page-title-box">
                                <h4 class="page-title">Service Renewal Add</h4>
                                <ol class="breadcrumb p-0 m-0">
                                    <li>
                                        <a href="#">{{Session::get('software_title')}}</a>
                                    </li>
                                    <li>
                                        <a href="{{url('client/service/renewal/list')}}">Renewal List </a>
                                    </li>
                            ...
                            <div class="card-box">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="row">
                                            {{Form::open(['method'=>'post','route'=>'post.service_renewal_save','files'=>'true'])}}
                                            <div class="col-md-12">
                                                <div class="demo-box">
                                                    <div class="col-md-3">
