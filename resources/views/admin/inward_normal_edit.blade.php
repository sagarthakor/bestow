    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                {{Form::model($data,['method'=>'post','route'=>'post.inward_normal_update'])}}
                    ...
                    <div class="panel-body">
                        ...
                        <!-- <div class="col-md-4" style="display: none;" id="qno">
                            ...
                            <div class="col-md-6">
                                ...
                                {{Form::select('inward_from',$inward_from,null,['class'=>'form-control js-example-basic-single','id'=>'inward_from'])}}
     ...
     <span class="input-group-addon" id="start-date"><span class="glyphicon glyphicon-plus" style="cursor: pointer;" onclick="add_customer()"></span>
                            ...
                            <div class="col-md-6">
                                ...
                                {{Form::select('vendor',$vendor,null,['class'=>'form-control js-example-basic-single','id'=>'vendor','onchange'=>'getpo(this.value)'])}}
     ...
     <span class="input-group-addon" id="start-date"><span class="glyphicon glyphicon-plus" style="cursor: pointer;" onclick="add_customer()"></span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {{Form::text('inward_date',null,['class'=>'form-control input-daterange-datepicker','id'=>"quot_date",'autocomplete'=>'off'])}}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php
                                    $inwardtype=[''=>'select an Option','Returnable'=>'Returnable','Non Returnable'=>'Non Returnable','New Material Supplied'=>'New Material Supplied','New Material Purchased'=>'New Material Purchased'];
                                    ?>
                                    {{Form::select('inward_type',$inwardtype,null,['class'=>'form-control','id'=>"inward_type"])}}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {{Form::text('purchase',null,['class'=>'form-control','id'=>"purchase",'onchange'=>'get_item(this.value)'])}}
                                ...
                                <table class="table table-bordered-brown">
                                    <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: top !important;text-align: center;">
                                                <input type="text" name="received" onkeyup="cal(this)" value="{{$item->received_qty}}" class="received form-control" id="qty' . $srno . '">
                                            </td>
                                            <td style="vertical-align: top !important;text-align: center;">
                                                <input type="text" name="remaining" onkeyup="cal(this)" value="{{$item->remaining_qty}}" class="remaining form-control" id="qty' . $srno . '">
                                            </td>
                                        </tr>
