        ...
        <tr>
            ...
            <td colspan="5" style="text-align: right; border-left:none;vertical-align: top;">
                <table style="border: none;">
                    <tr> <td style="border: none;width:50%;text-align: left">  <img src="{{asset('public/company_logo/'.$company->logo)}}" height="80px"></td>
            ...
            <td colspan="3" style="vertical-align: top;font-size: 10px !important;border-left: none;text-align: right;">
                <table style="border: none;">
                    <tr style="border: none;">
                        <td style="border: none; font-weight: bold;text-align: right;">PO NO. :</td>
                        <td style="border: none;text-align: right;">{{$po->purchase_no}}</td>
                    </tr>
                    <tr style="border: none;">
                        <td style="border: none;font-weight: bold;text-align: right;">PO DATE :</td>
                        <td style="border: none;text-align: right;">{{date('d-m-Y',strtotime($po->po_date))}}</td>
                    </tr>
                    <tr style="border: none;">
                        <td style="border: none;font-weight: bold;text-align: right;">SO NO. :</td>
