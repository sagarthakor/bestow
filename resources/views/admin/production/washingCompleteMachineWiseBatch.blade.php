                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            <h4 class="page-title">{{$machine->machine_name}} Complete Washing Batch</h4>
                    ...
                    border: 1px solid #cccccc;height: 30px;padding: 3px 8px;"   value="<?php if(isset($_GET['total_washing'])){echo $_GET['total_washing'];} ?>">
                                ...
                                @foreach($list as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td  style="vertical-align: top;text-align: center;width: 10%">@if($data->washing_status=="Y") <i class="mdi mdi-checkbox-marked" style="color: green"></i> Complete @else Pending @endif</td>
                                        <td>
