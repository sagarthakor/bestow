                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            <h4 class="page-title">Washing Pending List </h4>
                            <ol class="breadcrumb p-0 m-0">
                                <li>
                                    <a href="{{ url('admin') }}">{{Session::get('software_title')}}</a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.production.washing.dashboard') }}">Washing Dashboard</a>
                                </li>

                                <li class="active">
                                    Washing Pending List
                                </li>
                            </ol>
                    ...
                    <div class="col-sm-12">
                        ...
                        @foreach($machine as $mlist)
                            <div class="col-lg-3 col-md-3 col-sm-6">
                                <a href="{{route('admin.production.washing.machine.batch',['id' => $mlist->id])}}">
