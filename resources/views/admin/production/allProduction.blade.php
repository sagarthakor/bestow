...
@section('title', 'All Production Batch List ')
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            <h4 class="page-title">All Production Batch List </h4>
                            <ol class="breadcrumb p-0 m-0">
                                <li>
                                    <a href="{{ url('admin') }}">{{Session::get('software_title')}}</a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.production.process') }}">Production Dashboard</a>
                                </li>
                                <li class="active">
                                    All Production Batch List
                                </li>
                            </ol>
                                ...
                                @foreach($production as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td width="10%"  style="vertical-align: top;">
                                            <a href="{{route("admin.production.details",['batch_no' => $data->batch_no])}}">{{$data->batch_no}} </a>
                                        </td>
                                        ...
                                        <td  style="vertical-align: top;text-align: center;width: 10%">@if($data->production_status=="Y") <i style="color:green" class="mdi mdi-checkbox-marked"></i>Complete @else <i class="mdi mdi-close-box" style="color: green"></i> Pending @endif</td>
                                        <td>
                                            <a href="{{route("admin.production.details",['batch_no' => $data->batch_no] )}}">View</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
