                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            <h4 class="page-title">{{$machine->machine_name}} Pending Batch</h4>
...
{{--                                            {{$data->machine_name}}</td>--}}
                                        ...
                                        <td  style="vertical-align: top;text-align: center">{{$data->total_wastage_nos}}</td>
                                        <td  style="vertical-align: top;text-align: center">{{(float)$data->nos - (float)$data->total_production - (float)$data->total_wastage_nos}}</td>
                                        ...
                                        <td>
                                            <a class="btn btn-primary btn-sm" href="{{route("admin.production.details",['batch_no' => $data->batch_no])}}">View</a>
                                            <a class="btn btn-danger btn-sm" href="{{ route('admin.production.machine.batch.delete', ['id' => $data->id]) }}">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
