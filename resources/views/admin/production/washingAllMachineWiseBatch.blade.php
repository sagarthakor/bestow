...
@section('title', 'All Washing Process')
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            <h4 class="page-title">All Washing Batch</h4>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ request('machine') }}" name="machine" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Batch No</label>
                                            <input type="text" value="{{ request('batch_no') }}" name="batch_no" id="batch_no" class="form-control" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Washing Nos</label>
                                            <input type="text" value="{{ request('total_washing') }}" name="total_washing" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control">
                                                ...
                                                <option value="Y" @selected(request('status') === 'Y')>Complete</option>
                                                <option value="N" @selected(request('status') === 'N')>Pending</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                @foreach($production as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td  style="vertical-align: top;text-align: center">{{$data->machine_name}}</td>
                                        <td width="10%"  style="vertical-align: top;">
                                            <a href="{{route("admin.production.washing.move",['batch_no' => $data->batch_no] )}}">{{$data->batch_no}} </a>
                                        </td>
                                        ...
                                        <td  style="vertical-align: top;text-align: center">{{$data->total_washing}}</td>
                                        <td  style="vertical-align: top;text-align: center;width: 10%">{{$data->size}}</td>
                                        <td  style="vertical-align: top;text-align: center;width: 10%">@if($data->washing_status=="Y") <i class="mdi mdi-checkbox-marked" style="color: green"></i> Complete @else <i class="mdi mdi-close-box" style="color: green"></i> Pending @endif</td>
                                        <td>
                                            <a href="{{route("admin.production.washing.move",['batch_no' => $data->batch_no] )}}">View</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
