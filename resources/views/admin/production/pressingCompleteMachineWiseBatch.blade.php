...
@section('title', 'Complete Pressing')
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            <h4 class="page-title">{{$machine->machine_name}} Complete Pressing Batch</h4>
                        ...
                        <div class="card-box">
                            ...
                            <form method="get">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Pressing Nos</label>
                                            <input type="text" value="{{ request('total_pressing') }}" name="total_pressing" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                @foreach($list as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td  style="vertical-align: top;text-align: center;width: 10%">@if($data->pressing_status=="Y") <i class="mdi mdi-checkbox-marked" style="color: green"></i> Complete @else Pending @endif</td>
                                        <td>
