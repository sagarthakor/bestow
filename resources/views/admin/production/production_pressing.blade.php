...
@section('title','Batch - '.$production->batch_no .' Pressing Process')
                    ...
                    <div class="col-xs-12">
                        <div class="card-box">
                            ...
                            <div class="row">
                                ...
                                @endif
                                <div class="col-xs-12">
                                    {{Form::open(['method'=>'post','route'=>'admin.production.pressing.record.save'])}}
                                    {{Form::hidden("batch_no",$production->batch_no)}}
                                    {{Form::hidden("pressing_id",$production->id)}}
                                    {{Form::hidden("stitching_id",$production->stitching_id)}}
                                    <div class="row">
                                        <div class="col-md-6">
...
{{--                                                            $production->actualMaterialUsed--}}
                                    ...
                                    @if($production->status=="Move to Washing")
                                        ...
                                        <div class="row">
                                          @if($last_record=="no")
                                             <div class="col-md-3 col-sm-3">
                                                        <button value="start" name="process" class="btn btn-success"><i class="mdi mdi-play"></i> Start Pressing</button>
                                             </div>

                                              <div class="col-md-3 col-sm-3">
                                                        <button value="pause" name="process" class="btn btn-danger"><i class="mdi mdi-pause"></i> Pause Pressing</button>
                                                    </div>

                                                     <div class="col-md-3 col-sm-3">
                                                        <button  value="end" name="process"  class="btn btn-danger"><i class="mdi mdi"></i> End Pressing</button>
                                                    </div>

                                            @else
                                                @if($last_batch_record->process=="start")
                                                <div class="col-md-3 col-sm-3">
                                                        <button disabled value="start" name="process" class="btn btn-success"><i class="mdi mdi-play"></i> Start Pressing</button>
                                                    </div>
                                                @else
                                                    <div class="col-md-3 col-sm-3">
                                                        <button value="start" name="process" class="btn btn-success"><i class="mdi mdi-play"></i> Start Pressing</button>
                                            ...
                                            @if($last_batch_record->process =="pause")
                                                    <div class="col-md-3 col-sm-3">
                                                        <button disabled value="pause" name="process" class="btn btn-danger"><i class="mdi mdi-pause"></i> Pause Pressing</button>
                                                    </div>
                                                @else
                                                 <div class="col-md-3 col-sm-3">
                                                        <button value="pause" name="process" class="btn btn-danger"><i class="mdi mdi-pause"></i> Pause Pressing</button>
                                                 ...
                                                 @endif
                                                  @if($last_batch_record->process  =="end")
                                                   <div class="col-md-3 col-sm-3">
                                                        <button disabled value="end" name="process"  class="btn btn-danger"><i class="mdi mdi"></i> End Pressing</button>
                                                    </div>
                                                  @else
                                                   <div class="col-md-3 col-sm-3">
                                                        <button  value="end" name="process"  class="btn btn-danger"><i class="mdi mdi"></i> End Pressing</button>
                                           ...
                                           @endif
                                            <div class="col-md-3 col-sm-3">
                                                <button id="finished" class="btn btn-danger"><i class="mdi mdi-play-protected-content"></i> Finished Pressing</button>
                                            </div>
                                        ...
                                        <div class="row" id="finished_record" style="margin-top: 15px">
                                            @else
                                                <div class="row" id="finished_record" style="margin-top: 15px;display: none">
                                                    @endif
                                                    <h2>Finished Pressing Process</h2>
                                                    <div class="col-md-6">
                                                        <table class="table table-bordered">
                                                            <tr>
                                                                <td>Total Pressing Socks No.</td>
                                                                <td><input @if($production->pressing_status == "Y") readonly @endif value="{{$production->total_pressing ?? ''}}" type="text" oninput="cal_product(this.value)" class="form-control" name="total_pressing"></td>
                                                            </tr>

                                                            <tr>
                                                                <td>Total Pressing Wastage Nos.</td>
                                                                <td><input @if($production->pressing_status == "Y") readonly @endif type="text" value="{{$production->total_pressing_wastage_nos ?? ''}}" id="total_wastage_nos" class="form-control" name="total_pressing_wastage_nos"></td>
                                                            </tr>
                                                    ...
                                                    <div class="col-md-6">
                                                        <table class="table table-bordered">
                                                            <tr>
                                                                <td>Total Pressing Material Used</td>
                                                                <td><input @if($production->pressing_status == "Y") readonly @endif type="text" value="{{$production->total_pressing_material_used ?? ''}}" class="form-control" id="total_material_used" name="total_pressing_material_used"></td>
                                                            </tr>

                                                            <tr>
                                                                <td>Total Pressing Wastage Material</td>
                                                                <td><input @if($production->pressing_status == "Y") readonly @endif type="text" value="{{$production->total_pressing_wastage_material ?? ''}}" class="form-control" id="total_wastage_used" name="total_pressing_wastage_material"></td>
                                                            </tr>
                                                ...
                                                @if($production->status=="Finished")
                                                    <button name="process" value="Move to Washing" class="btn btn-info">Move to Washing <i class="mdi mdi-arrow-right mdi-18px"></i></button>
                                                @endif
