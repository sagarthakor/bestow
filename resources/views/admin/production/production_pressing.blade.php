                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <table class="table table-bordered">
                                                ...
                                                <?php
                                                    $pressedSoFar = (float) ($production->total_pressing ?? 0);
                                                    $wastageSoFar = (float) ($production->total_pressing_wastage_nos ?? 0);
                                                    $targetNos = (float) $production->nos;
                                                    $remainingNos = $targetNos - $pressedSoFar - $wastageSoFar;
                                                ?>
                                                <tr>
                                                    <td>Pressed So Far</td>
                                                    <td>{{$pressedSoFar}} / {{$targetNos}} (Remaining: <span id="production_remaining">{{$remainingNos}}</span>)</td>
                                                </tr>
                                            </table>
                                        </div>
                                        <div class="col-md-6">
...
{{--                                                            $production->actualMaterialUsed--}}
                                    ...
                                    @if($production->pressing_status != "Y")
                                        <div class="row" id="finished_record" style="margin-top: 15px">
                                            <h2>Today's Pressing Entry</h2>
                                            <div class="col-md-6">
                                                <table class="table table-bordered">
                                                    <tr>
                                                        <td>Today's Pressing Qty</td>
                                                        <td><input value="" type="text" oninput="cal_product(this.value)" class="form-control" name="total_pressing"></td>
                                                    </tr>

                                                    <tr>
                                                        <td>Today's Wastage Nos.</td>
                                                        <td><input type="text" value="" id="total_wastage_nos" class="form-control" name="total_pressing_wastage_nos"></td>
                                                    </tr>
                                            ...
                                            <div class="col-md-6">
                                                <table class="table table-bordered">
                                                    <tr>
                                                        ...
                                                        <td><input type="text" value="" class="form-control" id="total_material_used" name="total_pressing_material_used"></td>
                                                    </tr>

                                                    <tr>
                                                        <td>Today's Wastage Material</td>
                                                        <td><input type="text" value="" class="form-control" id="total_wastage_used" name="total_pressing_wastage_material"></td>
                                                    </tr>
                                        ...
                                        <div class="row" id="finished_submit">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <button class="btn btn-success" name="process" value="Finished">Submit Today's Pressing &amp; Forward to Washing</button>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    @else
                                        <div class="row" style="margin-top: 15px">
                                            <div class="col-md-12">
                                                <div class="alert alert-success">Batch fully pressed ({{$production->total_pressing}} / {{$production->nos}}) and forwarded to Washing.</div>
                                            </div>
                                        </div>
                                    @endif
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        @foreach($batch_record as $record)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center">{{$record->total_pressing}}</td>
                                                                <td style="text-align: center">{{$record->total_pressing_wastage_nos}}</td>
            ...
            <script>
                ...
                // the full target - a pressing row can be completed across
