...
@section('title', 'All Packaging Process')
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            <h4 class="page-title">All Packaging Batch</h4>
                        ...
                        <div class="card-box">
                            ...
                            <form method="get">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Packaging Nos</label>
                                            <input type="text" value="{{ request('total_packaging') }}" name="total_packaging" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                ...
                                @foreach($production as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td width="10%"  style="vertical-align: top;">
                                            <a href="{{route("admin.production.packaging.move",['batch_no' => $data->batch_no] )}}">{{$data->batch_no}} </a>
                                        </td>
                                        ...
                                        <td  style="vertical-align: top;text-align: center">{{$data->total_packaging ?? 0}}</td>
                                        <td  style="vertical-align: top;text-align: center;width: 10%">{{$data->size}}</td>
                                        <td  style="vertical-align: top;text-align: center;width: 10%">@if($data->packaging_status=="Y") <i class="mdi mdi-checkbox-marked" style="color: green"></i> Complete @else <i class="mdi mdi-close-box" style="color: green"></i> Pending @endif</td>
                                        <td>
