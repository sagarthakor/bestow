            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    border: 1px solid #cccccc;height: 30px;padding: 3px 8px;"   value="<?php if(isset($_GET['nos'])){echo $_GET['nos'];} ?>">
                                    ...
                                    <td>
                                        <input type="text" name="total_packaging" style="width:85px;border-radius: 1px;
                    box-shadow: none;
                    border: 1px solid #cccccc;height: 30px;padding: 3px 8px;"   value="<?php if(isset($_GET['total_packaging'])){echo $_GET['total_packaging'];} ?>">
                                    </td>
                                    <td>
