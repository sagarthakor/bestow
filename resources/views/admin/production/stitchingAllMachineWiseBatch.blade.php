...
@section('title', 'All Stitching Process')
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            <h4 class="page-title">All Stitching Batch</h4>
                            <ol class="breadcrumb p-0 m-0">
                                <li>
                                    <a href="{{ url('admin') }}">{{Session::get('software_title')}}</a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.production.stitching.dashboard') }}">Stitching Dashboard</a>
                                </li>
                                <li class="active">
                                    Stitching All List
                                </li>
                        ...
                        <div class="card-box">
                            ...
                            <form method="get">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Stitching Nos</label>
                                            <input type="text" value="{{ request('stitching_nos') }}" name="stitching_nos" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                ...
                                @foreach($production as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td width="10%"  style="vertical-align: top;">
                                            <a href="{{route("admin.production.stitching.move",['batch_no' => $data->batch_no])}}">{{$data->batch_no}} </a>
                                        </td>
                                        ...
                                        <td  style="vertical-align: top;text-align: center">{{$data->total_stitching}}</td>
                                        <td  style="vertical-align: top;text-align: center;width: 10%">{{$data->size}}</td>
                                        <td  style="vertical-align: top;text-align: center;width: 10%">@if($data->stitching_status=="Y") <i style="color:green" class="mdi mdi-checkbox-marked"></i>Complete @else <i class="mdi mdi-close-box" style="color: green"></i> Pending @endif</td>
                                        <td>
                                            <a href="{{route("admin.production.stitching.move",['batch_no' => $data->batch_no])}}">View</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
