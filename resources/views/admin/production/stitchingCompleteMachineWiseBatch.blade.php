...
@section('title', 'Complete Stitching')
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            <h4 class="page-title">{{$machine->machine_name}} Complete Stitching Batch</h4>
                ...
                <div class="row">
                    ...
                    border: 1px solid #cccccc;height: 30px;padding: 3px 8px;"   value="<?php if(isset($_GET['nos'])){echo $_GET['nos'];} ?>">
                                    ...
                                    <td>
                                        <input type="text" name="stitching_nos" style="width:85px;border-radius: 1px;
                    box-shadow: none;
                    border: 1px solid #cccccc;height: 30px;padding: 3px 8px;"   value="<?php if(isset($_GET['stitching_nos'])){echo $_GET['stitching_nos'];} ?>">
                                    </td>
                                    <td>
                                ...
                                @foreach($list as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td  style="vertical-align: top;text-align: center;width: 10%">@if($data->stitching_status=="Y") <i class="mdi mdi-checkbox-marked" style="color: green"></i> Complete @else Pending @endif</td>
                                        <td>
