                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <table class="table table-bordered">
                                                ...
                                                <?php
                                                    $packagedSoFar = (float) ($production->total_packaging ?? 0);
                                                    $wastageSoFar = (float) ($production->total_packaging_wastage_nos ?? 0);
                                                    $targetNos = (float) $production->nos;
                                                    $remainingNos = $targetNos - $packagedSoFar - $wastageSoFar;
                                                ?>
                                                <tr>
                                                    <td>Packaged So Far</td>
                                                    <td>{{$packagedSoFar}} / {{$targetNos}} (Remaining: <span id="production_remaining">{{$remainingNos}}</span>)</td>
                                                </tr>
                                            </table>
                                        </div>
                                        <div class="col-md-6">
...
{{--                                                            $production->actualMaterialUsed--}}
                                    ...
                                    @if($production->packaging_status != "Y")
                                        <div class="row" id="finished_record" style="margin-top: 15px">
                                            <h2>Today's Packaging Entry</h2>
                                            <div class="col-md-6">
                                                <table class="table table-bordered">
                                                    <tr>
                                                        <td>Today's Packaging Qty</td>
                                                        <td><input value="" type="text" oninput="cal_product(this.value)" class="form-control" name="total_packaging"></td>
                                                    </tr>

                                                    <tr>
                                                        <td>Today's Wastage Nos.</td>
                                                        <td><input type="text" value="" id="total_wastage_nos" class="form-control" name="total_packaging_wastage_nos"></td>
                                                    </tr>
                                            ...
                                            <div class="col-md-6">
                                                <table class="table table-bordered">
                                                    <tr>
                                                        ...
                                                        <td><input type="text" value="" class="form-control" id="total_material_used" name="total_packaging_material_used"></td>
                                                    </tr>

                                                    <tr>
                                                        <td>Today's Wastage Material</td>
                                                        <td><input type="text" value="" class="form-control" id="total_wastage_used" name="total_packaging_wastage_material"></td>
                                                    </tr>
                                        ...
                                        <div class="row" id="finished_submit">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <button class="btn btn-success" name="process" value="Finished">Submit Today's Packaging &amp; Inward to Stock</button>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    @else
                                        <div class="row" style="margin-top: 15px">
                                            <div class="col-md-12">
                                                <div class="alert alert-success">Batch fully packaged ({{$production->total_packaging}} / {{$production->nos}}) and inward to stock.</div>
                                            </div>
                                        </div>
                                    @endif
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        @foreach($batch_record as $record)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center">{{$record->total_packaging}}</td>
                                                                <td style="text-align: center">{{$record->total_packaging_wastage_nos}}</td>
            ...
            <script>
                ...
                // the full target - a packaging row can be completed across
