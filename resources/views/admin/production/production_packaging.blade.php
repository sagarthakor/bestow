...
@section('title','Batch - '.$production->batch_no .' Packaging Process')
                    ...
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            ...
                            <ol class="breadcrumb p-0 m-0">
                                ...
                                <li>
                                    <a href="{{url('production/packaging/dashboard')}}">Packaging Dashboard </a>
                                </li>
                                <li>
                                    Batch Details
                                </li>
                    ...
                    <div class="col-xs-12">
                        <div class="card-box">
                            ...
                            <div class="row">
                                ...
                                @endif
                                <div class="col-xs-12">
                                    {{Form::open(['method'=>'post','route'=>'admin.production.packaging.record.save'])}}
                                    {{Form::hidden("batch_no",$production->batch_no)}}
                                    {{Form::hidden("packaging_id",$production->id)}}
...
{{--                                                            $production->actualMaterialUsed--}}
                                    ...
                                    @if($production->status=="Move to Stock")
                                        ...
                                        <div class="row">
                                            @if($last_record=="no")
                                             <div class="col-md-3 col-sm-3">
                                                        <button value="start" name="process" class="btn btn-success"><i class="mdi mdi-play"></i> Start Packaging</button>
                                             </div>

                                              <div class="col-md-3 col-sm-3">
                                                        <button value="pause" name="process" class="btn btn-danger"><i class="mdi mdi-pause"></i> Pause Packaging</button>
                                                    </div>

                                                     <div class="col-md-3 col-sm-3">
                                                        <button  value="end" name="process"  class="btn btn-danger"><i class="mdi mdi"></i> End Packaging</button>
                                                    </div>

                                            @else
                                                @if($last_batch_record->process=="start")
                                                <div class="col-md-3 col-sm-3">
                                                        <button disabled value="start" name="process" class="btn btn-success"><i class="mdi mdi-play"></i> Start Packaging</button>
                                                    </div>
                                                @else
                                                    <div class="col-md-3 col-sm-3">
                                                        <button value="start" name="process" class="btn btn-success"><i class="mdi mdi-play"></i> Start Packaging</button>
                                            ...
                                            @if($last_batch_record->process =="pause")
                                                    <div class="col-md-3 col-sm-3">
                                                        <button disabled value="pause" name="process" class="btn btn-danger"><i class="mdi mdi-pause"></i> Pause Packaging</button>
                                                    </div>
                                                @else
                                                 <div class="col-md-3 col-sm-3">
                                                        <button value="pause" name="process" class="btn btn-danger"><i class="mdi mdi-pause"></i> Pause Packaging</button>
                                                 ...
                                                 @endif
                                                  @if($last_batch_record->process  =="end")
                                                   <div class="col-md-3 col-sm-3">
                                                        <button disabled value="end" name="process"  class="btn btn-danger"><i class="mdi mdi"></i> End Packaging</button>
                                                    </div>
                                                  @else
                                                   <div class="col-md-3 col-sm-3">
                                                        <button  value="end" name="process"  class="btn btn-danger"><i class="mdi mdi"></i> End Packaging</button>
                                           ...
                                           @endif
                                            <div class="col-md-3 col-sm-3">
                                                <button id="finished" class="btn btn-danger"><i class="mdi mdi-play-protected-content"></i> Finished Packaging</button>
                                            </div>

                                        </div>
                                    @endif

                                    @if($production->status == "Finished" || $production->status =="Move to Washing")
                                        <div class="row" id="finished_record" style="margin-top: 15px">
                                            @else
                                                <div class="row" id="finished_record" style="margin-top: 15px;display: none">
                                                    @endif
                                                    <h2>Finished Packaging Process</h2>
                                                    <div class="col-md-6">
                                                        <table class="table table-bordered">
                                                            <tr>
                                                                <td>Total Packaging Socks No.</td>
                                                                <td><input @if($production->packaging_status == "Y") readonly @endif value="{{$production->total_packaging ?? ''}}" type="text" oninput="cal_product(this.value)" class="form-control" name="total_packaging"></td>
                                                            </tr>

                                                            <tr>
                                                                <td>Total Packaging Wastage Nos.</td>
                                                                <td><input @if($production->packaging_status == "Y") readonly @endif type="text" value="{{$production->total_packaging_wastage_nos ?? ''}}" id="total_wastage_nos" class="form-control" name="total_packaging_wastage_nos"></td>
                                                            </tr>
                                                    ...
                                                    <div class="col-md-6">
                                                        <table class="table table-bordered">
                                                            <tr>
                                                                <td>Total Packaging Material Used</td>
                                                                <td><input @if($production->packaging_status == "Y") readonly @endif type="text" value="{{$production->total_packaging_material_used ?? ''}}" class="form-control" id="total_material_used" name="total_packaging_material_used"></td>
                                                            </tr>

                                                            <tr>
                                                                <td>Total Packaging Wastage Material</td>
                                                                <td><input @if($production->packaging_status == "Y") readonly @endif type="text" value="{{$production->total_packaging_wastage_material ?? ''}}" class="form-control" id="total_wastage_used" name="total_packaging_wastage_material"></td>
                                                            </tr>

                                                        </table>
                                                    </div>
                                                    @if($production->status == "Finished" || $production->status =="Move to Stock")
                                                    @else
                                                ...
                                                @if($production->status=="Finished")
                                                    <button name="process" value="Move to Stock" class="btn btn-info">Move to Stock <i class="mdi mdi-arrow-right mdi-18px"></i></button>
                                                @endif
