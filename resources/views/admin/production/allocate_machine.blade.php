...
@section('title', 'Pending Production')
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            <h4 class="page-title">Production Pending List </h4>
                            <ol class="breadcrumb p-0 m-0">
                                <li>
                                    <a href="{{ url('admin') }}">{{Session::get('software_title')}}</a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.production.dashboard') }}">Production Dashboard</a>
                                </li>
                                <li class="active">
                                   <a href="{{route('admin.production.process')}}"> Production Batch</a>
                                </li>
                                <li class="active">
                    ...
                    <div class="col-sm-12">
                        ...
                        @foreach($machine as $mlist)
                            <div class="col-lg-3 col-md-3 col-sm-6">
                                <a href="{{route('admin.production.machine.batch',['id' => $mlist->id] )}}">
