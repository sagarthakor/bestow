    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                {{Form::model($data,['method'=>'post','route'=>'admin.quotation.update','role'=>'form','data-parsley-validate novalidate'])}}
                {{Form::hidden('id',null)}}
...
{{Form::select('customer',$customer,null,['required','class'=>'form-control js-example-basic-single','id'=>'customer','onchange'=>'getcustomer(this.value)'])}}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <label class="control-label">Quotation Date <span
                                                    style="color: red">*</span></label>
                                        {{Form::text('quot_date',date('d-m-Y',strtotime($data->quot_date)),['required',"readonly",'class'=>'form-control','autocomplete'=>'off'])}}
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                // 'any' so a saved line can be re-picked as a product, a
                // service or a BOM, the same as a row added here.
                $("select.product").each(function () {
                    initProductAjaxSelect2($(this), 'any');
                });
            ...
            function stage_change(stage) {
                ...
                {
                    var appurl="{{url('/')}}";
                    window.location.href=appurl+'/quot-revise/{{$data->id}}';
                }
...
$("#quot_date").datepicker({
            ...
            // the name the row builders below already call it by.
