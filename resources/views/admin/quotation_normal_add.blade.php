        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container">
                    ...
                    {{Form::open(['method'=>'post','route'=>'post.quot_normal_save','role'=>'form','data-parsley-validate novalidate'])}}
                                    ...
                                    <table class="table table-striped add-edit-table table-bordered" id="caltable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeX" id="row1">
                                                <td style="width: 20%">
                                                    <div class="input-group">
                                                     <select onchange="get_product(this.value,1)" name="product[]" id="product1" class="form-control js-example-basic-single" required>
