...
@section('title', 'Preview | RawMaterial')
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="page-title-box">
                                <h4 class="page-title">RawMaterial</h4>
                                <ol class="breadcrumb p-0 m-0">
                                    <li>
                                        <a href="#">{{Session::get('software_title')}}</a>
                                    </li>
                                    <li>
                                        <a href="{{url('client/raw-material/list')}}">RawMaterial List </a>
                                    </li>
                                ...
                                <div class="row">
                                    ...
                                    <ul class="nav nav-tabs">
                                        ...
                                        <ul class="nav navbar-nav navbar-right">
                                          <li><a href="{{url('client/raw_material/edit/'.$data->id)}}"><span class="glyphicon glyphicon-user"></span>Edit</a></li>
                                  ...
                                  <div class="tab-content">
                                      <div id="home" class="tab-pane fade in active">
                                        ...
                                        <label for="staticEmail" class="col-sm-6 col-form-label">Raw Material Group</label>
                                        <div class="col-sm-6">
                                         {{$data->raw_material_group}}
                                        </div>
                                    </div>
                                    </div>
