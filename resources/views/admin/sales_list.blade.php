                        ...
                        <div class="card-box table-responsive">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" value="<?php if(isset($_GET['salaesorder_no'])){echo $_GET['salaesorder_no'];} ?>" placeholder="Salesorder No." name="salaesorder_no" class="listSearchContributor inputElement">
                                    </td>
                                    <td>
                                        <input type="date" value="<?php if(isset($_GET['salesorder_date'])){echo $_GET['salesorder_date'];} ?>" placeholder="salesorder_date Date" name="salesorder_date" class="listSearchContributor inputElement">
                                    </td>
                                    <td>
                                ...
                                @foreach($list as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td width="12%"  style="vertical-align: top;">
                                            <a href="{{url('client/sales/view/'.$data->id)}}">{{$data->salaesorder_no}}</a></td>
                                        ...
                                        <td  style="vertical-align: top;">
                                            ...
                                            @can('sales_update')
                                                <a class="table-btn" title="edit"  href="{{url('client/so_edit/'.$data->id)}}"title="edit"><i class="fa fa-pencil" style="margin:10px;font-size: 10px;"></i></a>
                                            @endcan

                                            @can('sales_view')
                                                <a class="table-btn" title="preview" target="_blank" href="{{url('client/so_preview/'.$data->id)}}"><i class="fa fa-eye" style="margin:10px;font-size: 10px;"></i></a>
                                            @endcan
                                            @can('sales_print')
                                                <a class="table-btn" title="pdf"  href="{{url('client/so_print/'.$data->id)}}"><i class="fa fa-file-pdf-o" style="margin:10px;font-size: 10px;"></i></a>
                                            @endcan
