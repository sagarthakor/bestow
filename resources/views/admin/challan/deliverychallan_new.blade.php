...
@section('title', 'Add New | DeliveryChallan')
    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                    ...
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            ...
                            <ol class="breadcrumb p-0 m-0">
                                ...
                                <li>
                                    <a href="{{url('deliverychallan/list')}}">Delivery Challan List </a>
                                </li>
                                <li class="active">
                                    Creating New Delivery Challan
                                </li>
                            </ol>
                ...
                {{Form::model($data,['method'=>'post','route'=>'admin.sales.delivery_challan'])}}
                        ...
                        <!-- <div class="col-md-4" style="display: none;" id="qno">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{Form::text('quot_date',$quotDate,['class'=>'form-control input-daterange-datepicker','id'=>"quot_date",'autocomplete'=>'off'])}}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{Form::text('salaesorder_no',null,['class'=>'form-control','id'=>"salaesorder_no"])}}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">PO No.<span style="color: red">*</span></label>
                                    {{Form::text('purchase_order',null,["required",'class'=>'form-control','id'=>"subject"])}}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{Form::text('purchase_order_date',null,["required",'class'=>'form-control input-daterange-datepicker','id'=>"purchase_order_date"])}}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">DC. Date <span style="color: red">*</span></label>
                                    {{Form::text('invoice_date',date('d-m-Y'),['required','class'=>'form-control input-daterange-datepicker','id'=>"invoice_date",'autocomplete'=>'off'])}}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>DC. Stage <span style="color: red">*</span></label>
                                    <?php
                                    $arr=array(''=>'select status','Created'=>'Created','Approved'=>'Approved','Delivered'=>'Delivered','Cancelled'=>'Cancelled');
                                    ?>
                                    {{Form::select('status',$arr,null,['required','class'=>'form-control js-example-basic-single'])}}
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{Form::text('transport_name',null,['class'=>'form-control','id'=>"eway_billno",'autocomplete'=>'off'])}}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{Form::text('receipt_no',null,['class'=>'form-control','id'=>"eway_billno",'autocomplete'=>'off'])}}
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    {{Form::text('receipt_date',null,['class'=>'form-control input-daterange-datepicker','id'=>"receipt_date",'autocomplete'=>'off'])}}
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">Salesman Name <span style="color: red">*</span></label>
...
{{--                                            <th style="text-align: center;">THK</th>--}}
                                        ...
                                        @if(empty($data))
                                        @else
                                            @if($data->salaesorder_no!="")
                                                <?php
                                                $dc=\App\delivery_challan::where(['salaesorder_no' => $data->salaesorder_no])->first();
                                                if(empty($dc)){}else{
                                                    $dcitem=\App\delivery_challan_item::where(['invoice_no' => $dc->challan_number])->get();
                                                }
                                                ?>
                                            @endif
                                        @endif
                                        @forelse($quotitem as $item)
                                            @if($data->salaesorder_no!="")
                                                ...
                                                if(empty($dc)){
                                                    ...
                                                    $dcitem=\App\delivery_challan_item::where(['salaesorder_no' => $data->salaesorder_no,'product'=>$item->product])->sum("qty");
                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-control product js-example-basic-single" onchange="get_product(this)" name="product[]" id="product{{$srno}}">
                                                                ...
                                                                @foreach($product as $prod)
                                                                    ...
                                                                    @else
                                                                        <option style="background-color:red !important" value="{{$prod->id}}">{{$prod->product_name}} - Stock - {{$prod->stockqty}}</option>
                                                                    @endif
...
{{--                                                               class="smallInputBox inputElement inner_diameter" value="{{$item->inner_diamitter}}">--}}
{{--                                                    </td>--}}
{{--                                                    <td style="width:6%;vertical-align: top !important;text-align: center;">--}}
{{--                                                        <input type="text" name="outer_diamitter[]" id=""--}}
{{--                                                               class="smallInputBox inputElement outer_diameter" value="{{$item->outer_diamitter}}">--}}
{{--                                                    </td>--}}
{{--                                                    <td style="width:6%;vertical-align: top !important;text-align: center;">--}}
{{--                                                        <input type="text" name="thikness[]" id="" value="{{$item->thikness}}" class="smallInputBox inputElement thikness">--}}
{{--                                                    </td>--}}
                                                    <td style="vertical-align: top !important;text-align: center;">
                                                            <img class="photo" src="/product_image/{{$item->product_image}}" style="height: 55px" width="55px">
                                                    ...
                                                    <td style="vertical-align: top !important;text-align: center;width: 10%">
                                                        ...
                                                        <input type="hidden" readonly name="old_qty[]" onkeyup="cal(this)" value="{{$item->qty}}"
                                                               class="qty smallInputBox inputElement" id="qty{{$srno}}">
                                                        <label>Stock : {{$item->stockqty ?? 0}}</label>
                                                        <input type="hidden" class="stock" value="{{$item->stockqty ?? 0}}">
                                                    </td>
                                                    <td style="vertical-align: top !important;text-align: center;">
                                                ...
                                                <span>(-)&nbsp;<strong>
                                                        ...
                                                        <div class="individualTaxContainer">(+)&nbsp;
                                                            <strong>
                                                                <a style="cursor: pointer" onclick="taxDiv(this)">Tax </a> (<span class="taxTotal">{{$item->cgst_per+$item->sgst_per+$item->igst_per}}</span>%):
                                            ...
                                            @else
                                                @if($item->qty==$dcitem)
                                                    <tr style=""  id="row{{$srno}}">
                                                        ...
                                                        <td style="vertical-align: top !important;width: 35%">
                                                            <div class="form-group">
                                                                <select class="form-control product js-example-basic-single" onchange="get_product(this)" id="product{{$srno}}">
                                                                    <option value="{{$item->product}}">{{$item->product_name}}</option>
                                                                    @foreach($product as $prod)
                                                                        @if($prod->stockqty > 0)
                                                                            <option value="{{$prod->id}}">{{$prod->item_code}} - {{$prod->product_name}} - Stock - {{$prod->stockqty ?? 0}}</option>
                                                                ...
                                                                <label style="color:green">This item is deliver</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label>  </label>
                                                                <textarea style="width:100%" id="description{{$srno}}" class="description">{{$item->description}}</textarea>
...
{{--                                                        </td>--}}
{{--                                                        <td style="width:6%;vertical-align: top !important;text-align: center;">--}}
{{--                                                            <input type="text" id="" value="{{$item->thikness}}" class="smallInputBox inputElement thikness">--}}
{{--                                                        </td>--}}
                                                        <td style="vertical-align: top !important;text-align: center;">
                                                            <img src="/product_image/{{$item->product_image}}" style="height: 55px" width="55px">
                                                        </td>


                                                        <td style="vertical-align: top !important;text-align: center;">
                                                            <span class="hsnSpan">{{$item->hsn}}</span>
                                                            <input type="hidden" class="hsn smallInputBox inputElement" value="{{$item->hsn}}" id="">
                                                        </td>

                                                        <td style="vertical-align: top !important;text-align: center;width: 10%">
                                                            <input type="text" onkeyup="cal(this)" value="{{$item->qty-$dcitem}}"
                                                                   class="qty smallInputBox inputElement" id="qty{{$srno}}">
                                                            <input type="hidden" readonly onkeyup="cal(this)" value="{{$item->deliver_qty}}"
                                                                   class="qty smallInputBox inputElement" id="qty{{$srno}}">
                                                            <label>Stock : {{$item->stockqty ?? 0}}</label>
                                                            <input type="hidden" class="stock" value="{{$item->stockqty ?? 0}}">
                                                            <br><label>SO Qty : {{$item->qty}}</label>
                                                            <br><label>Deliver Qty : {{$dcitem}}</label>
                                                            <br><label>Pending Qty : {{$item->qty - $dcitem}}</label>
                                                        </td>
                                                        <td style="vertical-align: top !important;text-align: center;">
                                                            <span class="uomSpan">{{$item->uom_name}}</span>
                                                            <input type="hidden" class="uom smallInputBox inputElement" value="{{$item->uom_name}}"
                                                                   id="uom{{$srno}}">
                                                        </td>

                                                        <td style="vertical-align: top !important;">
                                                            <div>
                                                                <input oninput="cal(this)"  value="{{$item->price}}"
                                                                       type="text"
                                                                       data-rule-required="true" data-rule-positive="true"
                                                                       class="price listPrice smallInputBox inputElement"
                                                                       data-is-price-changed="false" list-info=""
                                                ...
                                                <div class="taxUI hide" id="tax_div1">
                                                    <p class="popover_title hide">Set Tax for : <span
                                                        ...
                                                        <td style="display:none;vertical-align: top !important;text-align: center;">
                                                            <input type="text" value="{{$item->cgst_per}}"
                                                                   class="cgst_per form-control" id="cgst_per{{$srno}}"
                                                                   oninput="cal(this)">
                                                        </td>
                                                        <td style="display:none;vertical-align: top !important;text-align: center;">
                                                            <input type="text" value="{{$item->cgst_amount}}"
                                                                   class="cgst_amount form-control" id="cgst_amount{{$srno}}">
                                                        </td>
                                                        <td style="display:none;vertical-align: top !important;text-align: center;">
                                                            <input type="text" value="{{$item->sgst_per}}"
                                                                   class="sgst_per form-control" id="sgst_per{{$srno}}"
                                                                   oninput="cal(this)">
                                                        </td>
                                                        <td style="display:none;vertical-align: top !important;text-align: center;">
                                                            <input type="text" value="{{$item->sgst_amount}}"
                                                                   class="sgst_amount form-control" id="sgst_amount{{$srno}}">
                                                        </td>
                                                        <td style="display:none;vertical-align: top !important;text-align: center;">
                                                            <input type="text" value="{{$item->igst_per}}"
                                                                   class="gst_per form-control" id="gst_per{{$srno}}"
                                                                   oninput="cal(this)">
                                                        </td>
                                                        <td style="display:none;vertical-align: top !important;text-align: center;">
                                                            <input type="text"  value="{{$item->igst_amount}}"
                                                                   class="gst_amount form-control" id="gst_amount{{$srno}}">
                                                        </td>
                                                        <td style="vertical-align: top !important;text-align: center;">

                                                            <input type="text" value="{{$item->grand_total}}"
                                                                   class="netprice smallInputBox inputElement" id="net_price{{$srno}}">
                                                        </td>
                                                        <td class="actions" style="vertical-align: top !important;text-align: center;">
                                                            <a onclick="remove_row(this)" style="cursor: pointer;"
                                                    ...
                                                    <tr style=""  id="row{{$srno}}">
                                                        ...
                                                        <td style="vertical-align: top !important;width: 35%">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control product js-example-basic-single" onchange="get_product(this)" name="{{$stockqty > 0 ? "product[]" : "product1[]" }}" id="product{{$srno}}">
                                                                    <option value="{{$item->product}}">{{$item->product_name}}</option>
                                                                    @foreach($product as $prod)
                                                                        @if($prod->stockqty > 0)
                                                                            <option value="{{$prod->id}}">{{$prod->item_code}} - {{$prod->product_name}} - Stock - {{$prod->stockqty ?? 0}}</option>
                                                                ...
                                                                <label style="color:red">This item not in stock</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label>  </label>
                                                                <textarea style="width:100%" id="description{{$srno}}" name="<?php if($stockqty > 0){echo "description[]";}else{echo "description1[]";}?>" class="description">{{$item->description}}</textarea>
...
{{--                                                        </td>--}}
                                                        ...
                                                        <td style="vertical-align: top !important;text-align: center;">
                                                            <span class="hsnSpan">{{$item->hsn}}</span>
                                                            <input type="hidden" class="hsn smallInputBox inputElement" name="<?php if($stockqty > 0){echo "hsn[]";}else{echo "hsn1[]";}?>" value="{{$item->hsn}}" id="">
                                                        </td>

                                                        <td style="vertical-align: top !important;text-align: center;width: 10%">
                                                            @php
                                                               $remainingQty = $item->qty-$dcitem;
                                                            @endphp
                                                            <input type="text" name="<?php if($stockqty > 0){echo "qty[]";}else{echo "qty1[]";}?>" onkeyup="cal(this)" value="{{$stockqty > $remainingQty ? $remainingQty : $stockqty}}"
                                                                   class="qty smallInputBox inputElement" id="qty{{$srno}}">
                                                            <input type="hidden" readonly name="<?php if($stockqty > 0){echo "old_qty[]";}else{echo "old_qty1[]";}?>" onkeyup="cal(this)" value="{{$item->deliver_qty}}"
                                                                   class="qty smallInputBox inputElement" id="qty{{$srno}}">
                                                            <div> <label>Stock : {{$item->stockqty ?? 0}}</label>
                                                            <input type="hidden" class="stock" value="{{$item->stockqty ?? 0}}">
                                                            <label style="display:none;" class="soqty">{{$item->qty}}</label>
                                                            <label style="display:none;" class="dcqty">{{$dcitem}}</label>
                                                            <br><label>SO Qty : {{$item->qty}}</label>
                                                            <br><label style="width: 100%;">Deliver Qty : {{$dcitem}}</label>
                                                                <br><label style="width: 100%;">Pending Qty : {{$item->qty - $dcitem}}</label></div>

                                                        </td>
                                                        <td style="vertical-align: top !important;text-align: center;">
                                                            <span class="uomSpan">{{$item->uom_name}}</span>
                                                            <input type="hidden" class="uom smallInputBox inputElement" name="<?php if($stockqty > 0){echo "uom[]";}else{echo "uom1[]";}?>" value="{{$item->uom_name}}"
                                                                   id="uom{{$srno}}">
                                                        </td>

                                                        <td style="vertical-align: top !important;">
                                                            <div>
                                                                <input oninput="cal(this)"  name="<?php if($stockqty > 0){echo "price[]";}else{echo "price1[]";}?>" value="{{$item->price}}"
                                                                       type="text"
                                                                       data-rule-required="true" data-rule-positive="true"
                                                                       class="price listPrice smallInputBox inputElement"
                                                                       data-is-price-changed="false" list-info=""
                                                ...
                                                <span>(-)&nbsp;<strong>
                                                        ...
                                                        <div class="discountDiv" style="display: none">
                                                            <div class="form-group" style="width: 50%;display: inline;float: left;">
                                                                <label>Disc %</label>
                                                                <input oninput="cal(this)"
                                                                       name="<?php if($stockqty > 0){echo "discount_per[]";}else{echo "discount_per1[]";}?>"
                                                                       value="{{$item->discount_per}}" type="text"
                                                                       data-rule-required="true"
                                                                       data-rule-positive="true"
                                                                       class="discount_per listPrice smallInputBox inputElement"
                                                            ...
                                                            <div class="form-group" style="width: 50%;float: left;">
                                                                <label>Disc Amt</label>
                                                                <input oninput="discmatcal(this)"
                                                                       name="<?php if($stockqty > 0){echo "discount_amount[]";}else{echo "discount_amount1[]";}?>"
                                                                       value="{{$item->discount_amount}}" type="text"
                                                                       class="discount_amount inputElement" style="width: 80%;">
                                                                ...
                                                                <strong>
                                                                    ...
                                                                    <div style="display:none;" class="taxdiv">
                                                                        <div class="form-group" style="width: 34%;display:inline;float: left;">
                                                                            <label>CGST %</label>
                                                                            <input style="width: 35px;" oninput="cal(this)"
                                                                                   name="<?php if($stockqty > 0){echo "cgst_per1[]";}else{echo "cgst_per1[]";}?>"
                                                                                   value="{{$item->cgst_per}}" type="text"
                                                                                   data-rule-required="true" data-rule-positive="true"
                                                                                   class="cgst_per listPrice smallInputBox inputElement"
                                                                                   data-is-price-changed="false" list-info=""
                                                                        ...
                                                                        <div class="form-group" style="width: 34%;display:inline;float: left;">
                                                                            <label>SGST %</label>
                                                                            <input style="width: 35px;" oninput="cal(this)"
                                                                                   name="<?php if($stockqty > 0){echo "sgst_per1[]";}else{echo "sgst_per1[]";}?>"
                                                                                   value="{{$item->sgst_per}}" type="text"
                                                                                   data-rule-required="true" data-rule-positive="true"
                                                                                   class="sgst_per listPrice smallInputBox inputElement"
                                                                                   data-is-price-changed="false" list-info=""
                                                                        ...
                                                                        <div class="form-group" style="width: 32%;float: left;">
                                                                            <div class="form-group" >
                                                                                <label>IGST %</label>
                                                                                <input style="width: 35px;" oninput="cal(this)"
                                                                                       name="<?php if($stockqty > 0){echo "gst_per1[]";}else{echo "gst_per1[]";}?>"
                                                                                       value="{{$item->igst_per}}" type="text"
                                                                                       data-rule-required="true" data-rule-positive="true"
                                                                                       class="gst_per listPrice smallInputBox inputElement"
                                                                                       data-is-price-changed="false" list-info=""
                                                ...
                                                <div class="taxUI hide" id="tax_div1">
                                                    <p class="popover_title hide">Set Tax for : <span
                                                        ...
                                                        <td style="vertical-align: top !important;">
                                                            <input type="hidden" class="total" value="{{$item->total}}" name="<?php if($stockqty > 0){echo "total_amount[]";}else{echo "total_amount1[]";}?>">
                                                            <div  align="right" class="productTotal">{{$item->total}}</div>
                                                            <div  align="right" class="discountTotal">
                                                                {{$item->discount_amount}}
                                                            </div>
                                                        ...
                                                        <td style="display:none;vertical-align: top !important;text-align: center;">
                                                            <input type="text" name="<?php if($stockqty > 0){echo "cgst_per[]";}else{echo "cgst_per1[]";}?>"  value="{{$item->cgst_per}}"
                                                                   class="cgst_per form-control" id="cgst_per{{$srno}}"
                                                                   oninput="cal(this)">
                                                        </td>
                                                        <td style="display:none;vertical-align: top !important;text-align: center;">
                                                            <input type="text" name="<?php if($stockqty > 0){echo "cgst_amount[]";}else{echo "cgst_amount1[]";}?>" value="{{$item->cgst_amount}}"
                                                                   class="cgst_amount form-control" id="cgst_amount{{$srno}}">
                                                        </td>
                                                        <td style="display:none;vertical-align: top !important;text-align: center;">
                                                            <input type="text" name="<?php if($stockqty > 0){echo "sgst_per[]";}else{echo "sgst_per1[]";}?>" value="{{$item->sgst_per}}"
                                                                   class="sgst_per form-control" id="sgst_per{{$srno}}"
                                                                   oninput="cal(this)">
                                                        </td>
                                                        <td style="display:none;vertical-align: top !important;text-align: center;">
                                                            <input type="text" name="<?php if($stockqty > 0){echo "sgst_amount[]";}else{echo "sgst_amount1[]";}?>" value="{{$item->sgst_amount}}"
                                                                   class="sgst_amount form-control" id="sgst_amount{{$srno}}">
                                                        </td>
                                                        <td style="display:none;vertical-align: top !important;text-align: center;">
                                                            <input type="text" name="<?php if($stockqty > 0){echo "gst_per[]";}else{echo "gst_per1[]";}?>" value="{{$item->igst_per}}"
                                                                   class="gst_per form-control" id="gst_per{{$srno}}"
                                                                   oninput="cal(this)">
                                                        </td>
                                                        <td style="display:none;vertical-align: top !important;text-align: center;">
                                                            <input type="text" name="<?php if($stockqty > 0){echo "gst_amount[]";}else{echo "gst_amount1[]";}?>" value="{{$item->igst_amount}}"
                                                                   class="gst_amount form-control" id="gst_amount{{$srno}}">
                                                        </td>
                                                        <td style="vertical-align: top !important;text-align: center;">

                                                            <input type="text" name="<?php if($stockqty > 0){echo "net_price[]";}else{echo "net_price1[]";}?>" value="{{$item->grand_total}}"
                                                                   class="netprice smallInputBox inputElement" id="net_price{{$srno}}">
                                                        </td>
                                                        <td class="actions" style="vertical-align: top !important;text-align: center;">
                                                            <a onclick="remove_row(this)" style="cursor: pointer;"
                                        ...
                                        <tr>
                                            <td colspan="7" style="text-align: right;">Discount Total</td>
                                        ...
                                        <tr>
                                            <td colspan="7" style="text-align: right;">CGST Total</td>
                                        ...
                                        <tr>
                                            <td colspan="7" style="text-align: right;">SGST Total</td>
                                        ...
                                        <tr>
                                            <td colspan="7" style="text-align: right;">IGST Total</td>
                                            <td style="text-align: right;" colspan="2"><input oninput="cal(this)" type="text" class="form-control gsttotal"
                                                                                              ...
                                                                                              value="{{$data->igstamount?? 0}}"></td>

                                        </tr>
                                        <tr>
                                            <td colspan="7" style="text-align: right;">Adjustment</td>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        {{Form::select("module",$module,null,['class'=>'form-control','id'=>'module','required'=>'required'])}}
                ...
                <script type="text/javascript">
                    ...
                    $(document).ready(function() {
                        ...
                        $('tr').each(function(index, element) {
                            // Call the cal function for the current <tr> element
                            cal(this);
                        });
                    });
    ...
    $(document).ready(function () {
        ...
        function get_product(ele) {
            ...
            if(customer==""){
                ...
                $(ele).closest('tr').find('.total').val(0);
                $(ele).closest('tr').find('.discount_per').val(0);
                $(ele).closest('tr').find('.discount_amount').val(0);
                ...
                $(ele).closest('tr').find('.netprice').val(0);


                $.ajax({
                    url: appurl + '/admin/invoice/get_product',
                    ...
                    success: function (data) {
                        ...
                        if (len > 0) {
                            ...
                            var product_image = "{{ asset('/product_image') }}/" + productData.product_image;

                            $(ele).closest('tr').find('.description').val(data[0]['description']);
                            $(ele).closest('tr').find('.price').val(data[0]['price']);
                            $(ele).closest('tr').find('.photo').attr("src",product_image);
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (len > 0) {
                        ...
                        $(ele).closest('tr').find(".total_amount").val(0);
                        $(ele).closest('tr').find(".discount_per").val(0);
                        $(ele).closest('tr').find(".discount_amount").val(0);
                        $(ele).closest('tr').find(".gst_per").val(0);
                        $(ele).closest('tr').find(".gst_amount").val(0);
        ...
        function cal1(ele) {
            ...
            var rate = $(ele).closest('tr').find('.price').val();
            var qty = $(ele).closest('tr').find('.qty').val();
            var stock = $(ele).closest('tr').find('.stock').val();
        ...
        function cal(ele) {
            ...
            if(parseInt(qty) > parseInt(stock))
            {
                ...
                var soqty = $(ele).closest('tr').find('.soqty').text();
                var dcqty = $(ele).closest('tr').find('.dcqty').text();
                var totalqty=Number(qty)+Number(dcqty);

                if(soqty != '' && dcqty != '' && Number(totalqty) > Number(soqty))
                {
                    alert("do not enter more qty");
                    $(ele).closest('tr').find('.qty').val(0);
                }
...
{{--            data +='<td style="vertical-align: top !important;text-align:center"><input type="text" name="thikness[]"  class="smallInputBox inputElement thikness" id="thikness'+i+'"></td>';--}}
            ...
            data +='<td style="vertical-align: top !important;text-align: center;">\n' +
                ...
                '                                            <label class="stockQty">Stock : </label> - <span class="uomSpan"></span><input type="hidden" class="stock">\n' +
                '                                        </td>\n' +
                '                                        <td style="vertical-align: top !important;text-align: center;">\n' +
...
{{--            data +='<td style="vertical-align: top !important;text-align:center"><input type="text" name="thikness[]"  class="smallInputBox inputElement thikness" id="thikness'+i+'"></td>';--}}
            ...
            data +='<td style="vertical-align: top !important;text-align: center;">\n' +
                ...
                '                                        </td>\n' +
                '                                        <td style="vertical-align: top !important;text-align: center;width: 10%">\n' +
                '                                            <input type="text" name="qty[]" onkeyup="cal1(this)" value="0"\n' +
                '                                                   class="qty smallInputBox inputElement" id="">\n' +
                '                                            <label class="stockQty">Stock : </label> - <span class="uomSpan"></span><input type="hidden" class="stock">\n' +
                '                                        </td>\n' +
                '                                        <td style="vertical-align: top !important;text-align: center;">\n' +
