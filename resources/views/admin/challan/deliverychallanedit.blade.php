...
@section('title', 'Edit | Deliverychallan')
    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                {{Form::model($data,['method'=>'post','route'=>'post.so_deliverychallan_update'])}}
                {{Form::hidden('id',null)}}
                <div class="panel">
                        ...
                        <!-- <div class="col-md-4" style="display: none;" id="qno">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    {{Form::text('receipt_date',$receipt_date,['class'=>'form-control input-daterange-datepicker','id'=>"receipt_date",'autocomplete'=>'off'])}}
...
{{--                                                    </td>--}}
                                            ...
                                            @else
                                                <tr style=""  id="row{{$srno}}">
                                                    <td w style='vertical-align: top !important;text-align: center;width:10%'><input type="text" value="{{$item->bar_code}}"  onfocusout="search_product(this)" class="itemname form-control"></td>
