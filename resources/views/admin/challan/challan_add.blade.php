...
<head>
    ...
    <!-- App title -->
    <title>{{Session::get('software_title')}} - Delivery Challan Add</title>
    <style>
    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                {{Form::open(['method'=>'post','route'=>'post.challan_save','role'=>'form','data-parsley-validate novalidate'])}}
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {{Form::select('contact_name',[''=>'select contact'],null,['required','class'=>'form-control js-example-basic-single','id'=>"contact_name"])}}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{Form::select('sales_order',[''=>'select so'],null,['class'=>'form-control js-example-basic-single','id'=>'sales_order','onchange'=>'get_so_item(this.value)'])}}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{Form::select('quotation',[''=>'select quote'],null,['class'=>'form-control js-example-basic-single','id'=>'quotation','onchange'=>'get_quot_item(this.value)'])}}
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive" id="itemrow">
