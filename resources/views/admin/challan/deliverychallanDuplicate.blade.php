    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                    ...
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            ...
                            <ol class="breadcrumb p-0 m-0">
                                ...
                                <li>
                                    <a href="{{url('invoice/list')}}">Delivery challan List </a>
                                </li>
                                <li class="active">
                ...
                {{Form::model($data,['method'=>'post','route'=>'post.so_deliverychallan_save'])}}
                {{Form::hidden('id',null)}}
                <div class="panel">
                        ...
                        <!-- <div class="col-md-4" style="display: none;" id="qno">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{Form::text('purchase_order_date',null,["required",'class'=>'form-control','id'=>"purchase_order_date"])}}
                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-control product js-example-basic-single" onchange="get_product(this)" name="product[]" id="product{{$srno}}">
                                                                ...
                                                                @foreach($product as $prod)
                                                                    @if($prod->stockqty > 0)
                                                                        <option value="{{$prod->id}}">{{$prod->item_code}} - {{ \App\product::nameWithVariantInline($prod->product_name, $prod->value1 ?? null, $prod->value2 ?? null) }} - Stock - {{$prod->stockqty ?? 0}}</option>
                                                                    @else
                                                                        <option style="background-color:red !important" value="{{$prod->id}}">{{ \App\product::nameWithVariantInline($prod->product_name, $prod->value1 ?? null, $prod->value2 ?? null) }} - Stock - {{$prod->stockqty}}</option>
                                                                    @endif
...
{{--                                                    </td>--}}
                                                    ...
                                                    <td style="vertical-align: top !important;text-align: center;width: 10%">
                                                        ...
                                                        <input type="hidden" readonly name="old_qty[]" onkeyup="cal(this)" value="{{$item->qty}}"
                                                               class="qty smallInputBox inputElement" id="qty{{$srno}}">
                                                        <label>Stock : {{$item->stockqty ?? 0}} + {{$item->qty}}</label>
                                                        <input type="hidden" class="stock" value="{{$finalStock ?? 0}}">
                                                    </td>
                                                    <td style="vertical-align: top !important;text-align: center;">
                                            ...
                                            @else
                                                <tr style=""  id="row{{$srno}}">
                                                    ...
                                                    <td style="vertical-align: top !important;width: 35%">
                                                        <div class="form-group">
                                                            <select class="form-control product js-example-basic-single" onchange="get_product(this)" name="<?php if($stockqty > 0){echo "product[]";}else{echo "product1[]";}?>" id="product{{$srno}}">
                                                                <option value="{{$item->product}}">{{ \App\product::nameWithVariantInline($item->product_name, $item->value1 ?? null, $item->value2 ?? null) }}</option>
                                                                @foreach($product as $prod)
                                                                    @if($prod->stockqty > 0)
                                                                        <option value="{{$prod->id}}">{{$prod->item_code}} - {{ \App\product::nameWithVariantInline($prod->product_name, $prod->value1 ?? null, $prod->value2 ?? null) }} - Stock - {{$prod->stockqty ?? 0}}</option>
...
{{--                                                    </td>--}}
        ...
        $("#add_product").click(function(e){
            ...
            var data="<tr id='row"+i+"'><td style='width: 20%'><div class='form-group'><select class='product form-control js-example-basic-single' onchange='get_product(this)' name='product[]' id='product"+i+"'> <option>select</option>@foreach($product as $prod)<option value='{{$prod->id}}'>{{$prod->item_code}} - {{ \App\product::nameWithVariantInline($prod->product_name, $prod->value1 ?? null, $prod->value2 ?? null) }} - Stock : {{$prod->stockqty ?? 0}}</option>@endforeach</select></div><div class='form-group'><label></label><textarea id='description"+i+"' name='description[]' class='form-control'></textarea></div></td>";
...
{{--            data +='<td style="vertical-align: top !important;text-align:center"><input type="text" name="thikness[]"  class="form-control thikness" id="thikness'+i+'"></td>';--}}
           ...
           data +='<td style="vertical-align: top !important;text-align:center"><img style="height: 55px;width: 55px;" src="" class="photo img-responsive"> </td>';
            data +='<td style="vertical-align: top !important;text-align: center;">\n' +
                ...
                '                                        </td>\n' +
                '                                        <td style="display:none;vertical-align: top !important;text-align: center;">\n' +
                '                                            <input type="text" name="igst_per[]" value=""\n' +
...
{{--            data +='<td style="vertical-align: top !important;text-align:center"><input type="text" name="thikness[]"  class="thikness form-control" id="thikness'+i+'"></td>';--}}
           data +='<td style="vertical-align: top !important;text-align:center"><img style="height: 55px;width: 55px;" src="" class="photo img-responsive"> </td>';
            data +='<td style="vertical-align: top !important;text-align: center;">\n' +
                ...
                '                                        <td style="vertical-align: top !important;text-align: center;">\n' +
                '\n' +
                '                                           <input type="hidden" class="total" name="net_price[]"><input type="text" value=""\n' +
                '                                                   class="netprice smallInputBox inputElement" id="">\n' +
                '                                        </td>';
