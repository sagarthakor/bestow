...
@section('title', 'Report | Press Pending')
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            <h4 class="page-title">Press Pending Report</h4>
                            <ol class="breadcrumb p-0 m-0">
                                <li><a href="{{ url('admin') }}">{{Session::get('software_title')}}</a></li>
                                <li>Reports</li>
                                <li class="active">Press Pending</li>
                            </ol>
                        ...
                        <div class="card-box" style="padding:0;">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped rpt-table">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="7" class="text-center" style="padding:30px;color:#999;">No pending press batches found</td>
                                        </tr>
                                    @endforelse
                                    </tbody>
                                </table>
