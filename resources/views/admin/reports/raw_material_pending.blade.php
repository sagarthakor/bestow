                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box" style="padding:0;">
                            ...
                            <div class="rpt-stats">
                                Raw Materials Pending: <b>{{ number_format($groups->count()) }}</b>
                                &nbsp;&nbsp;|&nbsp;&nbsp; Total Qty To Order: <b>{{ number_format($grandNeed, 2) }}</b>
                            </div>
                                    ...
                                    @forelse($groups as $materialName => $rows)
                                        ...
                                        @foreach($rows as $row)
                                            <tr>
                                                ...
                                                <td>{{ $row->customer ?? '-' }}</td>
                                                <td style="text-align:right;">{{ number_format($row->required_qty, 2) }}</td>
                                                <td style="text-align:right;">{{ number_format($row->avalible_stock, 2) }}</td>
