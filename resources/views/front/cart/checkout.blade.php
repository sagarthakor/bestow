...
@section('content')
    ...
    <div class="container">
        ...
        <div class="cart-page">
            ...
            @endif
            {{Form::model($data,['method'=>'post','route'=>'placeorder'])}}
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                    ...
                                    @foreach(session('cart') as $id => $details)
                                        ...
                                        <tr>
                                            <td> <a href="{{url('product-details/c/s/'.$details['name'])}}">
                                                    <img style="height: 80px;width: 80px" src="/product_image/{{$details['photo']}}" alt="">
                                                </a></td>
                                            <td>{{$details['name']}}</td>
                                ...
                                <tr>
                                    ...
                                    <th><i class="fas fa-rupee-sign"></i> @if($total==null) - @else {{$total}} @endif</th>
                                </tr>
                                <tr>
                                    <th style="text-align: right" colspan="3">Shipping:</th>

                                    <th ><i class="fas fa-rupee-sign"></i> 00.00</th>
                                </tr>
                                <tr>
                                    <th style="text-align: right" colspan="3">Total:</th>

                                    <th><span class="cart-total"><i class="fas fa-rupee-sign"></i> @if($total==null) - @else {{$total}}.00 @endif</span></th>
                                </tr></tbody>
                            </table>
