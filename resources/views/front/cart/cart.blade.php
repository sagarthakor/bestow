...
@section('content')
                        ...
                        <div class="table-content table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="hidden" class="cart_product_id" name="id" value="{{$id}}">
                                    ...
                                    <td class="product-remove">
                                        ...
                                        <button name="delete_cart" value="delete_cart"><i style="margin: 5px;cursor: pointer;" title="Remove Item From Cart" data-id="{{ $id }}" class="remove-from-cart fa fa-trash"></i></button>
                                    </td>
    ...
    $(document).on('click', '.qtybutton', function (ele) {
        ele.preventDefault();
        var ele = $(this);
        var id=ele.parents("tr").find(".cart_product_id").val();
    ...
    $(document).on('click', '.remove-from-cart', function (ele) {
        ele.preventDefault();
        var ele = $(this);
        var id=ele.parents("tr").find(".cart_product_id").val();
