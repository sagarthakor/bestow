                                       ...
                                       <div class="row">
                                          <div class="col-md-4">
                                             <li>
                                                ...
                                                <div class="product-image">
                                                   <a href="view.php">
                                                   <img class="pic-1" src="{{asset('public/assets/images/product/b-1.jpg')}}" alt="Product image">
                                                   </a>
                                                   <ul class="social">
                                          ...
                                          <div class="col-md-4">
                                             <li>
                                                ...
                                                <div class="product-image">
                                                   <a href="view.php">
                                                   <img class="pic-1" src="{{asset('public/assets/images/product/b-2.jpg')}}" alt="Product image">
                                                   </a> 
                                                   <ul class="social">
                                                      <li><a href="view.php" data-tip="Quick View"><i class="fa fa-eye"></i></a></li>
                                                      <li><a href="wishlist.php" data-tip="Wishlist"><i class="fa fa-shopping-bag"></i></a></li>
                                          ...
                                          <div class="col-md-4">
                                             <li>
                                                ...
                                                <div class="product-image">
                                                   <a href="view.php">
                                                   <img class="pic-1" src="{{asset('public/assets/images/product/b-3.jpg')}}" alt="Product image">
                                                   </a>
                                                   <ul class="social">
                                                      <li><a href="view.php" data-tip="Quick View"><i class="fa fa-eye"></i></a></li>
                                                      <li><a href="wishlist.php" data-tip="Wishlist"><i class="fa fa-shopping-bag"></i></a></li>
