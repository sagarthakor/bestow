                                ...
                                <div class="demo-box">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                                        ...
                                                        <div class="form-group">
                                                            <label> Primary Email (Login Email)<span style="color: red">*</span></label>
                                                            {{Form::email('primary_email',null,['class'=>'form-control'.$errors->first('primary_email',' error')])}}

                                                            @if($errors->has('primary_email'))
                                                                <p class="help-block">{{ $errors->first('primary_email') }}</p>
                                                            @endif
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label> Password (Login Password)<span style="color: red">*</span></label>
                                                            {{Form::text('password',null,['class'=>'form-control'.$errors->first('password',' error')])}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            {{Form::textarea('billing_address',null,['class'=>'form-control1'.$errors->first('billing_address',' error'),'cols'=>'1','rows'=>'1','style'=>'min-height: 18px !important;height:46px','id'=>'billing_address'])}}
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            {{Form::select('billing_country',$country,null,['class'=>'form-control1'.$errors->first('billing_country',' error'),'id'=>"billing_country"])}}
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            {{Form::select('billing_state',$state,null,['class'=>'form-control1'.$errors->first('billing_state',' error'),'id'=>"billing_state"])}}
                                    ...
                                    <div class="col-md-12">
                                      ...
                                      <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                {{Form::textarea('shipping_address',null,['class'=>'form-control1'.$errors->first('shipping_address',' error'),'cols'=>'1','rows'=>'1','style'=>'min-height: 38px !important;height:46px','id'=>'shipping_address'])}}
