...
<html>
    <head>
        ...
        <!-- App title -->
        <title>Zircos - Master Module Add</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Master Module Add </h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="#">Zircos</a>
                                        </li>
                                        <li>
                                            <a href="{{url('master/module-list')}}">Master Module List </a>
                                        </li>
...
@endif
                                        <div class="col-xs-12">
                                            ...
                                            <div class="row">
                                                {{Form::open(['method'=>'post','route'=>'post.master_module_save'])}}
                                                <div class="col-md-12">
                                                    <div class="demo-box">
                                                        <div class="col-md-6">
