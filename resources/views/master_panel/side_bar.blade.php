     @if(!session()->has('master_user_id'))
        <script type="text/javascript">
            window.location="{{url('masteradmin')}}";
        </script>
     @endif
      <div class="topbar">
                ...
                <div class="topbar-left">
                    <a href="{{url('master')}}" class="logo"><span>Zir<span>cos</span></span><i class="mdi mdi-layers"></i></a>
                    <!-- Image logo -->
 ...
 -->
                            ...
                            <li class="dropdown user-box">
                                <a href="" class="dropdown-toggle waves-effect user-link" data-toggle="dropdown" aria-expanded="true">
                                    <img src="{{asset('public/adminpanel/default/assets/images/users/avatar-1.jpg')}}" alt="user-img" class="img-circle user-img">
                                </a>

                                <ul class="dropdown-menu dropdown-menu-right arrow-dropdown-menu arrow-menu-right user-list notify-list">
                                    <li>
                                        <h5>Hi, {{Session()->get('master_user_name')}}</h5>
                                    </li>
                                  <!--   <li><a href="javascript:void(0)"><i class="ti-user m-r-5"></i> Profile</a></li>
                                    <li><a href="javascript:void(0)"><i class="ti-settings m-r-5"></i> Settings</a></li>
                                    <li><a href="javascript:void(0)"><i class="ti-lock m-r-5"></i> Lock screen</a></li> -->
                                    <li><a href="{{url('master/logout')}}"><i class="ti-power-off m-r-5"></i> Logout</a></li>
                                </ul>
                            </li>
  ...
  <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="{{url('master')}}" class="waves-effect"><i class="mdi mdi-view-dashboard"></i><span> Dashboard </span> </a>
                               <!--  <ul class="list-unstyled">
                                    <li><a href="index.html">Dashboard 1</a></li>
                                    <li><a href="dashboard_2.html">Dashboard 2</a></li>
                                </ul> -->
                            </li>
                            @if(session()->has('master_module'))
                            
                                  @foreach(Session()->get('master_module') as $menu)
                                        <li class="has_sub">
                                            <a href="{{url($menu->module_url)}}" class="waves-effect"><i class="mdi mdi-invert-colors"></i> <span>{{$menu->module_name}}</span></a>
                                        </li>
                                  @endforeach
                            @endif
                          
                            <!--  <li class="has_sub">
                                <a href="{{url('master/user-list')}}" class="waves-effect"><i class="mdi mdi-invert-colors"></i> <span>User List</span></a>
                            </li>

                             <li class="has_sub">
                                <a href="{{url('master/master-list')}}" class="waves-effect"><i class="mdi mdi-invert-colors"></i> <span>Master Login</span></a>
                            </li>

                             <li class="has_sub">
                                <a href="{{url('master/module-list')}}" class="waves-effect"><i class="mdi mdi-invert-colors"></i> <span>Module List</span></a>
                            </li>

                              <li class="has_sub">
                                <a href="{{url('master/master-module-list')}}" class="waves-effect"><i class="mdi mdi-invert-colors"></i> <span>Master Module</span></a>
                            </li>
                             -->
