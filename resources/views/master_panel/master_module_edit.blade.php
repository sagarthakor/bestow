...
<html>
    <head>
        ...
        <!-- App title -->
        <title>Zircos - Master Module Edit</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Master Module Edit </h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="#">Zircos</a>
                                        </li>
                                        <li>
                                            <a href="{{url('master/master-module-list')}}">Master Module List </a>
                                        </li>
...
@endif
                                        <div class="col-xs-12">
                                            ...
                                            <div class="row">
                                                {{Form::model($data,['method'=>'post','route'=>'post.master_module_update'])}}
                                                {{Form::hidden('id',null)}}
                                                <div class="col-md-12">
                                                    <div class="demo-box">
                                                        <div class="col-md-6">
